  ...
  func.func @resnet_block(%arg0: memref<4096x576xi32>, %arg1: memref<576xi32>, %arg2: memref<4096xi32>, %arg3: memref<4096xi32>, %arg4: memref<4096x576xi32>, %arg5: memref<576xi32>, %arg6: memref<4096xi32>, %arg7: memref<4096xi32>, %arg8: memref<4096xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg9: memref<4096xi32>, %arg10: memref<4096x576xi32>, %arg11: memref<576xi32>, %arg12: memref<4096xi32>):
      ...
      ^bb0(%arg13: memref<4096xi32>, %arg14: memref<4096x576xi32>, %arg15: memref<576xi32>):
        ...
        %10:2 = "neura.fused_op"(%7, %9) <{frequency = 9 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ...
        %14 = "neura.fused_op"(%11, %12, %13) <{frequency = 6 : i64, pattern_id = 11 : i64, pattern_name = "mul->fused_op:load_indexed->add"}> ({
        ...
        %17:2 = "neura.fused_op"(%6, %16) <{frequency = 9 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ^bb0(%arg16: !neura.data<index, i1>, %arg17: !neura.data<index, i1>):
        ...
        %21 = "neura.fused_op"(%18, %19, %20) <{frequency = 6 : i64, pattern_id = 11 : i64, pattern_name = "mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg16: !neura.data<i32, i1>, %arg17: !neura.data<i32, i1>, %arg18: !neura.data<index, i1>):
          %37 = "neura.mul"(%arg16, %arg17) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %38 = neura.load_indexed [%arg18 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %39 = "neura.add"(%38, %37) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        %24:2 = "neura.fused_op"(%5, %23) <{frequency = 9 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ^bb0(%arg16: !neura.data<index, i1>, %arg17: !neura.data<index, i1>):
        ...
        %28 = "neura.fused_op"(%25, %26, %27) <{frequency = 6 : i64, pattern_id = 11 : i64, pattern_name = "mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg16: !neura.data<i32, i1>, %arg17: !neura.data<i32, i1>, %arg18: !neura.data<index, i1>):
          %37 = "neura.mul"(%arg16, %arg17) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %38 = neura.load_indexed [%arg18 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %39 = "neura.add"(%38, %37) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
    ...
    ^bb0(%arg9: memref<4096xi32>, %arg10: memref<4096xi32>, %arg11: i32):
      ...
      ^bb0(%arg12: memref<4096xi32>, %arg13: i32, %arg14: memref<4096xi32>):
        ...
        %12:2 = "neura.fused_op"(%5, %10) <{frequency = 3 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ...
        %15:2 = "neura.fused_op"(%4, %9) <{frequency = 3 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg15: !neura.data<index, i1>, %arg16: !neura.data<i32, i1>):
        ...
        %18:2 = "neura.fused_op"(%3, %8) <{frequency = 3 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg15: !neura.data<index, i1>, %arg16: !neura.data<i32, i1>):
    ...
    ^bb0(%arg9: memref<4096xi32>, %arg10: memref<4096xi32>, %arg11: memref<4096xi32>):
      ...
      ^bb0(%arg12: memref<4096xi32>, %arg13: memref<4096xi32>, %arg14: memref<4096xi32>):
        ...
        %3:3 = "neura.fused_op"(%2) <{frequency = 9 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ...
        %8:3 = "neura.fused_op"(%7) <{frequency = 9 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ^bb0(%arg15: !neura.data<index, i1>):
        ...
        %13:3 = "neura.fused_op"(%12) <{frequency = 9 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ^bb0(%arg15: !neura.data<index, i1>):
