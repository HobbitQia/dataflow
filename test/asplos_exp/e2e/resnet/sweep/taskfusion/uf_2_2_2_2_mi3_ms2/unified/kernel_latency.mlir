    ...
    ^bb0(%arg9: memref<4096xi32>, %arg10: memref<4096x576xi32>, %arg11: memref<576xi32>, %arg12: memref<4096xi32>):
      ...
      ^bb0(%arg13: memref<4096xi32>, %arg14: memref<4096x576xi32>, %arg15: memref<576xi32>):
        %2:6 = "neura.fused_op"() <{frequency = 2 : i64, pattern_id = 0 : i64, pattern_name = "fused_op:counter->load_indexed->fused_op:fused_op:counter->load_indexed->fused_op:add->load_indexed"}> ({
          ...
          %7 = neura.counter {counter_id = 1 : i32, counter_type = "leaf", lower_bound = 0 : index, step = 2 : index, upper_bound = 576 : index} : !neura.data<index, i1>
          ...
          %10 = neura.load_indexed [%5, %9 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          neura.yield results(%5, %6, %7, %8, %9, %10 : !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<index, i1>, !neura.data<i32, i1>)
        ...
        %3 = "neura.fused_op"(%2#4, %2#5, %2#0) <{frequency = 2 : i64, pattern_id = 7 : i64, pattern_name = "load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg16: !neura.data<index, i1>, %arg17: !neura.data<i32, i1>, %arg18: !neura.data<index, i1>):
          %5 = neura.load_indexed [%arg16 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %6 = "neura.mul"(%arg17, %5) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %7 = neura.load_indexed [%arg18 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %4 = "neura.fused_op"(%2#0, %2#2, %2#3, %2#1) <{frequency = 2 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:load_indexed->mul->add"}> ({
        ^bb0(%arg16: !neura.data<index, i1>, %arg17: !neura.data<index, i1>, %arg18: !neura.data<i32, i1>, %arg19: !neura.data<i32, i1>):
          %5 = neura.load_indexed [%arg16, %arg17 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %6 = "neura.mul"(%5, %arg18) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %7 = "neura.add"(%arg19, %6) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
    ...
    ^bb0(%arg9: memref<4096xi32>, %arg10: memref<4096xi32>, %arg11: i32):
      ...
      ^bb0(%arg12: memref<4096xi32>, %arg13: i32, %arg14: memref<4096xi32>):
        ...
        ^bb0(%arg15: !neura.data<i32, i1>):
          ...
          %5 = "neura.icmp"(%arg15) <{cmpType = "sgt"}> {rhs_value = "%input1"} : (!neura.data<i32, i1>) -> !neura.data<i1, i1>
          %6 = "neura.sel"(%5, %arg15, %4) : (!neura.data<i1, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        ^bb0(%arg15: !neura.data<i32, i1>, %arg16: !neura.data<i32, i1>):
          %4 = "neura.icmp"(%arg15) <{cmpType = "sgt"}> {rhs_value = "%input1"} : (!neura.data<i32, i1>) -> !neura.data<i1, i1>
          %5 = "neura.sel"(%4, %arg15, %arg16) : (!neura.data<i1, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
