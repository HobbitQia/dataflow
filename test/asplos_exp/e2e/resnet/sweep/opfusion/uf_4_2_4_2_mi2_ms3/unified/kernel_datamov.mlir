  ...
  func.func @conv2d_1(%arg0: memref<4096x576xi32>, %arg1: memref<576xi32>, %arg2: memref<4096xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg3: memref<4096xi32>, %arg4: memref<4096x576xi32>, %arg5: memref<576xi32>, %arg6: memref<4096xi32>):
      ...
      ^bb0(%arg7: memref<4096xi32>, %arg8: memref<4096x576xi32>, %arg9: memref<576xi32>):
        ...
        %10:2 = "neura.fused_op"(%7, %9) <{frequency = 6 : i64, pattern_id = 2 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ...
        %14 = "neura.fused_op"(%11, %12, %13) <{frequency = 6 : i64, pattern_id = 6 : i64, pattern_name = "mul->fused_op:load_indexed->add"}> ({
        ...
        %17:2 = "neura.fused_op"(%6, %16) <{frequency = 6 : i64, pattern_id = 2 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
        ...
        %21 = "neura.fused_op"(%18, %19, %20) <{frequency = 6 : i64, pattern_id = 6 : i64, pattern_name = "mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<i32, i1>, %arg11: !neura.data<i32, i1>, %arg12: !neura.data<index, i1>):
          %37 = "neura.mul"(%arg10, %arg11) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %38 = neura.load_indexed [%arg12 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %39 = "neura.add"(%38, %37) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        %24:2 = "neura.fused_op"(%5, %23) <{frequency = 6 : i64, pattern_id = 2 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
        ...
        %28 = "neura.fused_op"(%25, %26, %27) <{frequency = 6 : i64, pattern_id = 6 : i64, pattern_name = "mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<i32, i1>, %arg11: !neura.data<i32, i1>, %arg12: !neura.data<index, i1>):
          %37 = "neura.mul"(%arg10, %arg11) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %38 = neura.load_indexed [%arg12 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %39 = "neura.add"(%38, %37) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        %31 = "neura.fused_op"(%30, %8) <{frequency = 12 : i64, pattern_id = 3 : i64, pattern_name = "load_indexed->add"}> ({
