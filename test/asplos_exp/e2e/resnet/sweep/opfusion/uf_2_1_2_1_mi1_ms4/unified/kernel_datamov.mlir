  ...
  func.func @conv2d_1(%arg0: memref<4096x576xi32>, %arg1: memref<576xi32>, %arg2: memref<4096xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg3: memref<4096xi32>, %arg4: memref<4096x576xi32>, %arg5: memref<576xi32>, %arg6: memref<4096xi32>):
      ...
      ^bb0(%arg7: memref<4096xi32>, %arg8: memref<4096x576xi32>, %arg9: memref<576xi32>):
        ...
        %9:2 = "neura.fused_op"() <{frequency = 15 : i64, pattern_id = 1 : i64, pattern_name = "counter->load_indexed"}> ({
        ...
        %13 = "neura.fused_op"(%7, %11, %12) <{frequency = 8 : i64, pattern_id = 3 : i64, pattern_name = "load_indexed->mul"}> ({
        ...
        %22 = "neura.fused_op"(%5, %20, %21) <{frequency = 8 : i64, pattern_id = 3 : i64, pattern_name = "load_indexed->mul"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>, %arg12: !neura.data<i32, i1>):
          %26 = neura.load_indexed [%arg10, %arg11 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %27 = "neura.mul"(%26, %arg12) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%27 : !neura.data<i32, i1>)
        ...
        %24 = "neura.fused_op"(%4, %23) <{frequency = 6 : i64, pattern_id = 2 : i64, pattern_name = "load_indexed->add"}> ({
