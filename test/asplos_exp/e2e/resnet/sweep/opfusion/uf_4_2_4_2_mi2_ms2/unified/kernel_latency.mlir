  ...
  func.func @conv2d_1(%arg0: memref<4096x576xi32>, %arg1: memref<576xi32>, %arg2: memref<4096xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg3: memref<4096xi32>, %arg4: memref<4096x576xi32>, %arg5: memref<576xi32>, %arg6: memref<4096xi32>):
      ...
      ^bb0(%arg7: memref<4096xi32>, %arg8: memref<4096x576xi32>, %arg9: memref<576xi32>):
        ...
        %4:2 = "neura.fused_op"(%3#0, %2) <{frequency = 6 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ...
        %5 = "neura.fused_op"(%4#0, %4#1, %2) <{frequency = 6 : i64, pattern_id = 12 : i64, pattern_name = "mul->fused_op:load_indexed->add"}> ({
        ...
        %6:2 = "neura.fused_op"(%3#0, %2) <{frequency = 6 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
        ...
        %7 = "neura.fused_op"(%6#0, %6#1, %2) <{frequency = 6 : i64, pattern_id = 12 : i64, pattern_name = "mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<i32, i1>, %arg11: !neura.data<i32, i1>, %arg12: !neura.data<index, i1>):
          %11 = "neura.mul"(%arg10, %arg11) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %12 = neura.load_indexed [%arg12 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %13 = "neura.add"(%12, %11) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        %8:2 = "neura.fused_op"(%3#0, %2) <{frequency = 6 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:add->load_indexed->load_indexed"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
        ...
        %9 = "neura.fused_op"(%8#0, %8#1, %2) <{frequency = 6 : i64, pattern_id = 12 : i64, pattern_name = "mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<i32, i1>, %arg11: !neura.data<i32, i1>, %arg12: !neura.data<index, i1>):
          %11 = "neura.mul"(%arg10, %arg11) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %12 = neura.load_indexed [%arg12 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %13 = "neura.add"(%12, %11) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        %10 = "neura.fused_op"(%2, %3#1) <{frequency = 12 : i64, pattern_id = 5 : i64, pattern_name = "load_indexed->add"}> ({
  ...
  func.func @add_residual(%arg0: memref<4096xi32>, %arg1: memref<4096xi32>, %arg2: memref<4096xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg3: memref<4096xi32>, %arg4: memref<4096xi32>, %arg5: memref<4096xi32>):
      ...
      ^bb0(%arg6: memref<4096xi32>, %arg7: memref<4096xi32>, %arg8: memref<4096xi32>):
        ...
        %2 = "neura.fused_op"(%1#1) <{frequency = 2 : i64, pattern_id = 11 : i64, pattern_name = "load_indexed->fused_op:load_indexed->add"}> ({
        ...
        %3 = "neura.fused_op"(%1#0) <{frequency = 2 : i64, pattern_id = 11 : i64, pattern_name = "load_indexed->fused_op:load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
          %4 = neura.load_indexed [%arg9 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %5 = neura.load_indexed [%arg9 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %6 = "neura.add"(%5, %4) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
