  ...
  func.func @llama_attention_ffn(%arg0: memref<16xi32>, %arg1: memref<16x16xi32>, %arg2: memref<16xi32>, %arg3: memref<16xi32>, %arg4: memref<1xi32>, %arg5: memref<16x16xi32>, %arg6: memref<16xi32>, %arg7: memref<16x16xi32>, %arg8: memref<16xi32>, %arg9: memref<16x16xi32>, %arg10: memref<16xi32>, %arg11: memref<16xi32>, %arg12: memref<16x16xi32>, %arg13: memref<16xi32>) {
    ...
    ^bb0(%arg14: memref<16xi32>, %arg15: memref<16xi32>, %arg16: memref<16x16xi32>, %arg17: memref<16xi32>):
      ...
      ^bb0(%arg18: memref<16xi32>, %arg19: memref<16xi32>, %arg20: memref<16x16xi32>):
        ...
        %4:2 = "neura.fused_op"(%3#0) <{frequency = 7 : i64, pattern_id = 1 : i64, pattern_name = "fused_op:counter->add->fused_op:load_indexed->fused_op:load_indexed->mul"}> ({
        ...
        %5 = "neura.fused_op"(%3#0, %4#0, %3#1) <{frequency = 3 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:load_indexed->fused_op:load_indexed->mul->add"}> ({
    ...
    ^bb0(%arg14: memref<16xi32>, %arg15: memref<16xi32>, %arg16: memref<16x16xi32>, %arg17: memref<16xi32>, %arg18: memref<16x16xi32>, %arg19: memref<16xi32>, %arg20: memref<16x16xi32>, %arg21: memref<16xi32>, %arg22: memref<16xi32>, %arg23: memref<16xi32>):
      ...
      ^bb0(%arg24: memref<16xi32>, %arg25: memref<16xi32>, %arg26: memref<16x16xi32>, %arg27: memref<16xi32>, %arg28: memref<16x16xi32>, %arg29: memref<16xi32>, %arg30: memref<16x16xi32>):
        ...
        ^bb0(%arg31: !neura.data<index, i1>):
          ...
          %11 = neura.load_indexed [%10, %arg31 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
        ...
        %5:2 = "neura.fused_op"(%3#1, %4#1, %3#0, %4#0) <{frequency = 6 : i64, pattern_id = 0 : i64, pattern_name = "add->fused_op:fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ...
        %6 = "neura.fused_op"(%4#0, %3#0, %5#0) <{frequency = 6 : i64, pattern_id = 0 : i64, pattern_name = "add->fused_op:fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ...
        %7 = "neura.fused_op"(%4#0, %3#0, %5#0) <{frequency = 6 : i64, pattern_id = 0 : i64, pattern_name = "add->fused_op:fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg31: !neura.data<index, i1>, %arg32: !neura.data<index, i1>, %arg33: !neura.data<i32, i1>):
          %9 = "neura.add"(%arg31) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %10 = neura.load_indexed [%arg32, %9 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %11 = "neura.mul"(%arg33, %10) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %12 = neura.load_indexed [%arg32 : !neura.data<index, i1>]  {lhs_value = "%input3"} : !neura.data<i32, i1>
          %13 = "neura.add"(%12, %11) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%13 : !neura.data<i32, i1>)
        }) : (!neura.data<index, i1>, !neura.data<index, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %8 = "neura.fused_op"(%3#0, %4#0, %5#0) <{frequency = 6 : i64, pattern_id = 8 : i64, pattern_name = "fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg31: !neura.data<index, i1>, %arg32: !neura.data<index, i1>, %arg33: !neura.data<i32, i1>):
        ...
        neura.store_indexed %5#1 to [%3#0 : !neura.data<index, i1>]  {rhs_value = "%input3"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %6 to [%3#0 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.yield {yield_type = "void"}
      }
