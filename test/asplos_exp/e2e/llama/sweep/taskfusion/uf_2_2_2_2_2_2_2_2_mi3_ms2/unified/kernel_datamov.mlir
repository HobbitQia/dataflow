  ...
  func.func @llama_attention_ffn(%arg0: memref<16xi32>, %arg1: memref<16x16xi32>, %arg2: memref<16xi32>, %arg3: memref<16xi32>, %arg4: memref<1xi32>, %arg5: memref<16x16xi32>, %arg6: memref<16xi32>, %arg7: memref<16x16xi32>, %arg8: memref<16xi32>, %arg9: memref<16x16xi32>, %arg10: memref<16xi32>, %arg11: memref<16xi32>, %arg12: memref<16x16xi32>, %arg13: memref<16xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg14: memref<16xi32>, %arg15: memref<16xi32>, %arg16: memref<16x16xi32>, %arg17: memref<16xi32>):
      ...
      ^bb0(%arg18: memref<16xi32>, %arg19: memref<16xi32>, %arg20: memref<16x16xi32>):
        ...
        %10:2 = "neura.fused_op"(%8) <{frequency = 6 : i64, pattern_id = 1 : i64, pattern_name = "fused_op:counter->add->fused_op:load_indexed->fused_op:load_indexed->mul"}> ({
        ...
        %13 = "neura.fused_op"(%7, %11, %9) <{frequency = 3 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:load_indexed->fused_op:load_indexed->mul->add"}> ({
        ^bb0(%arg21: !neura.data<index, i1>, %arg22: !neura.data<index, i1>, %arg23: !neura.data<i32, i1>):
          %17 = neura.load_indexed [%arg21, %arg22 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %18 = neura.load_indexed [%arg22 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %19 = "neura.mul"(%18, %17) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %20 = "neura.add"(%arg23, %19) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        neura.store_indexed %14 to [%6 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        %15 = "neura.fused_op"(%5, %12) <{frequency = 9 : i64, pattern_id = 4 : i64, pattern_name = "load_indexed->add"}> ({
        ^bb0(%arg21: !neura.data<index, i1>, %arg22: !neura.data<i32, i1>):
          %17 = neura.load_indexed [%arg21 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %18 = "neura.add"(%17, %arg22) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        neura.store_indexed %16 to [%4 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
    ...
    ^bb0(%arg14: memref<16xi32>, %arg15: memref<16xi32>, %arg16: memref<16x16xi32>, %arg17: memref<16xi32>, %arg18: memref<16x16xi32>, %arg19: memref<16xi32>, %arg20: memref<16x16xi32>, %arg21: memref<16xi32>, %arg22: memref<16xi32>, %arg23: memref<16xi32>):
      ...
      ^bb0(%arg24: memref<16xi32>, %arg25: memref<16xi32>, %arg26: memref<16x16xi32>, %arg27: memref<16xi32>, %arg28: memref<16x16xi32>, %arg29: memref<16xi32>, %arg30: memref<16x16xi32>):
        ...
        %9:3 = "neura.fused_op"(%7) <{frequency = 5 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:counter->load_indexed->fused_op:load_indexed->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg31: !neura.data<index, i1>):
          ...
          %33 = neura.load_indexed [%arg31, %31 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %34 = neura.load_indexed [%arg31 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %15 = "neura.data_mov"(%9#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %16 = "neura.data_mov"(%9#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %17 = "neura.data_mov"(%9#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %18 = "neura.data_mov"(%9#1) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %19 = "neura.data_mov"(%9#2) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %20:2 = "neura.fused_op"(%18, %19, %17, %6) <{frequency = 5 : i64, pattern_id = 0 : i64, pattern_name = "add->fused_op:fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ...
        %25 = "neura.fused_op"(%5, %16, %23) <{frequency = 5 : i64, pattern_id = 0 : i64, pattern_name = "add->fused_op:fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ...
        %27 = "neura.fused_op"(%15, %4, %22) <{frequency = 6 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg31: !neura.data<index, i1>, %arg32: !neura.data<index, i1>, %arg33: !neura.data<i32, i1>):
        ...
        neura.store_indexed %24 to [%14 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input3"} : !neura.data<i32, i1>
        %29 = "neura.fused_op"(%13, %8, %21) <{frequency = 6 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg31: !neura.data<index, i1>, %arg32: !neura.data<index, i1>, %arg33: !neura.data<i32, i1>):
          %31 = neura.load_indexed [%arg31, %arg32 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %32 = "neura.mul"(%arg33, %31) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %33 = neura.load_indexed [%arg31 : !neura.data<index, i1>]  {lhs_value = "%input3"} : !neura.data<i32, i1>
          %34 = "neura.add"(%33, %32) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%34 : !neura.data<i32, i1>)
        }) {latency = 2 : i32} : (!neura.data<index, i1>, !neura.data<index, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %30 = "neura.data_mov"(%29) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        neura.store_indexed %30 to [%12 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input3"} : !neura.data<i32, i1>
        neura.store_indexed %28 to [%11 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.store_indexed %26 to [%10 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.yield {latency = 1 : i32, yield_type = "void"}
      }
