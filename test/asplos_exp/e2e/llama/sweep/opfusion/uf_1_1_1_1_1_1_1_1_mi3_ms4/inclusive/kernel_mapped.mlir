  ...
  func.func @qk_attention(%arg0: memref<16xi32>, %arg1: memref<16x16xi32>, %arg2: memref<16xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg3: memref<16xi32>, %arg4: memref<16xi32>, %arg5: memref<16x16xi32>, %arg6: memref<16xi32>):
      ...
      ^bb0(%arg7: memref<16xi32>, %arg8: memref<16xi32>, %arg9: memref<16x16xi32>):
        %2:4 = "neura.fused_op"() <{frequency = 4 : i64, pattern_id = 0 : i64, pattern_name = "fused_op:counter->load_indexed->fused_op:fused_op:counter->load_indexed->load_indexed"}> ({
          %9 = neura.counter {counter_id = 1 : i32, counter_type = "leaf", dfg_id = 0 : i32, lower_bound = 0 : index, step = 1 : index, upper_bound = 16 : index} : !neura.data<index, i1>
          %10 = neura.load_indexed [%9 : !neura.data<index, i1>]  {dfg_id = 5 : i32, lhs_value = "%input1"} : !neura.data<i32, i1>
          %11 = neura.counter {counter_id = 0 : i32, counter_type = "root", dfg_id = 1 : i32, lower_bound = 0 : index, step = 1 : index, upper_bound = 16 : index} : !neura.data<index, i1>
          %12 = neura.load_indexed [%11 : !neura.data<index, i1>]  {dfg_id = 7 : i32, lhs_value = "%input0"} : !neura.data<i32, i1>
          %13 = neura.load_indexed [%11, %9 : !neura.data<index, i1>, !neura.data<index, i1>]  {dfg_id = 6 : i32, lhs_value = "%input2"} : !neura.data<i32, i1>
          neura.yield results(%10, %11, %12, %13 : !neura.data<i32, i1>, !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>) {dfg_id = 13 : i32}
        }) {dfg_id = 2 : i32, latency = 1 : i32, mapping_locs = [{id = 5 : i32, index_per_ii = 0 : i32, invalid_iterations = 0 : i32, resource = "tile", time_step = 0 : i32, x = 1 : i32, y = 1 : i32}]} : () -> (!neura.data<i32, i1>, !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>)
        %3 = "neura.data_mov"(%2#0) {dfg_id = 8 : i32, mapping_locs = [{id = 160 : i32, index_per_ii = 0 : i32, invalid_iterations = 0 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 0 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %4 = "neura.data_mov"(%2#1) {dfg_id = 9 : i32, mapping_locs = [{id = 15 : i32, index_per_ii = 0 : i32, invalid_iterations = 0 : i32, resource = "link", time_step = 0 : i32}, {id = 32 : i32, index_per_ii = 1 : i32, invalid_iterations = 0 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 1 : i32}]} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %5 = "neura.data_mov"(%2#2) {dfg_id = 10 : i32, mapping_locs = [{id = 162 : i32, index_per_ii = 0 : i32, invalid_iterations = 0 : i32, per_tile_register_id = 2 : i32, resource = "register", time_step = 0 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        %7 = "neura.fused_op"(%3, %6, %5) <{frequency = 6 : i64, pattern_id = 3 : i64, pattern_name = "mul->add"}> ({
        ...
        neura.store_indexed %8 to [%4 : !neura.data<index, i1>]  {dfg_id = 17 : i32, latency = 1 : i32, mapping_locs = [{id = 1 : i32, index_per_ii = 0 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 2 : i32, x = 1 : i32, y = 0 : i32}], rhs_value = "%input0"} : !neura.data<i32, i1>
