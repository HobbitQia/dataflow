...
module attributes {dlti.dl_spec = #dlti.dl_spec<i32 = dense<32> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, llvm.ident = "Ubuntu clang version 14.0.0-1ubuntu1.1"} {
  ...
  ^bb1(%9: i64):  // 2 preds: ^bb0, ^bb3
    ...
    %13 = llvm.getelementptr inbounds %2[%0, %9] : (!llvm.ptr, i64, i64) -> !llvm.ptr, !llvm.array<512 x i32>
  ...
  ^bb2(%15: i64):  // 2 preds: ^bb1, ^bb2
    ...
    %20 = llvm.getelementptr inbounds %5[%0, %19] : (!llvm.ptr, i64, i64) -> !llvm.ptr, !llvm.array<262144 x i32>
  ...
  llvm.func local_unnamed_addr @_Z6kernelPKiS0_Pi(%arg0: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.readonly}, %arg1: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.readonly}, %arg2: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.writeonly}) attributes {frame_pointer = #llvm.framePointerKind<none>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic"} {
    %0 = llvm.mlir.constant(0 : i64) : i64
    %1 = llvm.mlir.constant(9 : i64) : i64
    %2 = llvm.mlir.constant(0 : i32) : i32
    %3 = llvm.mlir.constant(4 : i64) : i64
    %4 = llvm.mlir.constant(508 : i64) : i64
  ...
  ^bb2(%9: i64, %10: i32):  // 2 preds: ^bb1, ^bb2
    %11 = llvm.add %9, %8 overflow<nsw, nuw> : i64
    %12 = llvm.getelementptr inbounds %arg0[%11] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %13 = llvm.getelementptr inbounds %arg1[%9] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %14 = llvm.bitcast %12 : !llvm.ptr to !llvm.ptr
    %15 = llvm.load %14 {alignment = 4 : i64, tbaa = [#tbaa_tag]} : !llvm.ptr -> vector<4xi32>
    %16 = llvm.bitcast %13 : !llvm.ptr to !llvm.ptr
    %17 = llvm.load %16 {alignment = 4 : i64, tbaa = [#tbaa_tag]} : !llvm.ptr -> vector<4xi32>
    %18 = llvm.mul %17, %15 overflow<nsw> : vector<4xi32>
    %19 = "llvm.intr.vector.reduce.add"(%18) : (vector<4xi32>) -> i32
    %20 = llvm.add %19, %10 overflow<nsw> : i32
    %21 = llvm.add %9, %3 overflow<nsw, nuw> : i64
    %22 = llvm.icmp "ult" %9, %4 : i64
    llvm.cond_br %22, ^bb2(%21, %20 : i64, i32), ^bb3 {loop_annotation = #loop_annotation}
  ^bb3:  // pred: ^bb2
    %23 = llvm.getelementptr inbounds %arg2[%7] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %20, %23 {alignment = 4 : i64, tbaa = [#tbaa_tag]} : i32, !llvm.ptr
    %24 = llvm.add %7, %5 overflow<nsw, nuw> : i64
