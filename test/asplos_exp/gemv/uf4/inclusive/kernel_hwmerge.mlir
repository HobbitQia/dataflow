...
module attributes {dlti.dl_spec = #dlti.dl_spec<i32 = dense<32> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, llvm.ident = "Ubuntu clang version 14.0.0-1ubuntu1.1"} {
  ...
  func.func @_Z6kernelPKiS0_Pi(%arg0: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.readonly}, %arg1: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.readonly}, %arg2: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.writeonly}) -> !llvm.void attributes {CConv = #llvm.cconv<ccc>, accelerator = "neura", dataflow_mode = "predicate", frame_pointer = #llvm.framePointerKind<none>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, visibility_ = 0 : i64} {
    ...
    %22 = neura.phi_start %14#1, %21 : !neura.data<i64, i1>, !neura.data<i64, i1> -> !neura.data<i64, i1>
    ...
    %32 = neura.phi_start %14#0, %31 : !neura.data<i64, i1>, !neura.data<i64, i1> -> !neura.data<i64, i1>
    ...
    }) : (!neura.data<i32, i1>, !neura.data<i32, i1>, !neura.data<i1, i1>) -> (!neura.data<i32, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>)
    ...
    %41 = "neura.add"(%32, %40#0) : (!neura.data<i64, i1>, !neura.data<i64, i1>) -> !neura.data<i64, i1>
    ...
    }) : (!neura.data<!llvm.ptr, i1>, !neura.data<i64, i1>) -> !neura.data<vector<4xi32>, i1>
    ...
    }) : (!neura.data<!llvm.ptr, i1>, !neura.data<i64, i1>, !neura.data<vector<4xi32>, i1>) -> !neura.data<vector<4xi32>, i1>
    %44 = "neura.vector.reduce.add"(%43) : (!neura.data<vector<4xi32>, i1>) -> !neura.data<i32, i1>
    ...
    }) : (!neura.data<i32, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>, !neura.data<i1, i1>) -> (!neura.data<i32, i1>, !neura.data<i32, i1>)
    neura.ctrl_mov %39 -> %31 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %45#1 -> %30 : !neura.data<i32, i1> !neura.data<i32, i1>
    neura.ctrl_mov %40#1 -> %29 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %37#1 -> %28 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %36#1 -> %27 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %38#1 -> %26 : !neura.data<i64, i1> !neura.data<i64, i1>
    %46 = neura.grant_predicate %25, %33#0 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %46 -> %24 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %34#0 -> %23 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    %47 = neura.grant_predicate %22, %33#0 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %47 -> %21 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %33#4 -> %20 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %33#6 -> %19 : !neura.data<i64, i1> !neura.data<i64, i1>
    %48 = neura.grant_predicate %18, %33#0 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %48 -> %17 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %33#3 -> %16 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %35#2 -> %15 : !neura.data<i32, i1> !neura.data<i32, i1>
    %49 = neura.grant_predicate %45#0, %33#1 : !neura.data<i32, i1>, !neura.data<i1, i1> -> !neura.data<i32, i1>
    ...
    }) : (!neura.data<i64, i1>, !neura.data<i64, i1>, !neura.data<i64, i1>, !neura.data<i1, i1>, !neura.data<i64, i1>, !neura.data<i64, i1>) -> (!neura.data<i1, i1>, !neura.data<i1, i1>, !neura.data<i64, i1>, !neura.data<i64, i1>, !neura.data<i64, i1>, !neura.data<i64, i1>)
    %52 = "neura.gep"(%34#1, %50#0) <{operandSegmentSizes = array<i32: 1, 1>}> : (!neura.data<!llvm.ptr, i1>, !neura.data<i64, i1>) -> !neura.data<!llvm.ptr, i1>
    "neura.store"(%49, %52) : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
    ...
    neura.ctrl_mov %51#5 -> %13 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %51#4 -> %11 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %51#3 -> %10 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %56 -> %9 : !neura.data<i32, i1> !neura.data<i32, i1>
    neura.ctrl_mov %55 -> %8 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %54 -> %7 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %53 -> %6 : !neura.data<i64, i1> !neura.data<i64, i1>
    neura.ctrl_mov %51#2 -> %5 : !neura.data<i64, i1> !neura.data<i64, i1>
    %57 = neura.grant_predicate %34#1, %51#1 : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %57 -> %4 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    %58 = neura.grant_predicate %33#5, %51#1 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %58 -> %3 : !neura.data<i64, i1> !neura.data<i64, i1>
    %59 = neura.grant_predicate %33#7, %51#1 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %59 -> %2 : !neura.data<i64, i1> !neura.data<i64, i1>
    %60 = neura.grant_predicate %51#0, %51#0 : !neura.data<i1, i1>, !neura.data<i1, i1> -> !neura.data<i1, i1>
    neura.return_void %60 : !neura.data<i1, i1>
    neura.yield
  }
}
