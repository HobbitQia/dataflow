...
module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<272> = dense<64> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, llvm.ident = "Ubuntu clang version 14.0.0-1ubuntu1.1"} {
  ...
  ^bb2(%9: i64, %10: i32):  // 2 preds: ^bb1, ^bb2
    ...
    %14 = llvm.getelementptr inbounds %arg1[%9] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    ...
    %24 = llvm.mul %23, %20 overflow<nsw> : i32
    %25 = llvm.add %17, %24 overflow<nsw> : i32
    %26 = llvm.add %9, %4 overflow<nsw, nuw> : i64
    %27 = llvm.icmp "ult" %9, %5 : i64
    llvm.cond_br %27, ^bb2(%26, %25 : i64, i32), ^bb3 {loop_annotation = #loop_annotation}
  ^bb3:  // pred: ^bb2
    %28 = llvm.getelementptr inbounds %arg2[%7] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %25, %28 {alignment = 4 : i64, tbaa = [#tbaa_tag]} : i32, !llvm.ptr
    %29 = llvm.add %7, %3 overflow<nsw, nuw> : i64
    %30 = llvm.icmp "eq" %29, %6 : i64
    llvm.cond_br %30, ^bb4, ^bb1(%29 : i64) {loop_annotation = #loop_annotation}
  ^bb4:  // pred: ^bb3
    llvm.return
  }
}
