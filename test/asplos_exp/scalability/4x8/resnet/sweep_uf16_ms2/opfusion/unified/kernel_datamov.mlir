  ...
  func.func @conv2d_1(%arg0: memref<4096x576xi32>, %arg1: memref<576xi32>, %arg2: memref<4096xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg3: memref<4096xi32>, %arg4: memref<4096x576xi32>, %arg5: memref<576xi32>, %arg6: memref<4096xi32>):
      ...
      ^bb0(%arg7: memref<4096xi32>, %arg8: memref<4096x576xi32>, %arg9: memref<576xi32>):
        %2:4 = "neura.fused_op"() <{frequency = 60 : i64, pattern_id = 2 : i64, pattern_name = "fused_op:counter->fused_op:fused_op:counter->load_indexed->fused_op:load_indexed->mul->fused_op:fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
          %80 = neura.counter {counter_id = 0 : i32, counter_type = "root", lower_bound = 0 : index, step = 1 : index, upper_bound = 4096 : index} : !neura.data<index, i1>
          %81 = neura.counter {counter_id = 1 : i32, counter_type = "leaf", lower_bound = 0 : index, step = 16 : index, upper_bound = 576 : index} : !neura.data<index, i1>
          %82 = neura.load_indexed [%81 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = neura.load_indexed [%80, %81 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %84 = "neura.mul"(%83, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %85 = "neura.add"(%81) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %86 = neura.load_indexed [%80, %85 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          ...
          %89 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %90 = "neura.add"(%89, %88) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%80, %81, %84, %90 : !neura.data<index, i1>, !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>)
        ...
        %49 = "neura.data_mov"(%2#3) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %50 = "neura.fused_op"(%47, %33) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 2 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %85 = "neura.add"(%84, %83) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%85 : !neura.data<i32, i1>)
        }) {latency = 2 : i32} : (!neura.data<index, i1>, !neura.data<index, i1>) -> !neura.data<i32, i1>
        %51 = "neura.data_mov"(%50) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %52 = "neura.fused_op"(%46, %32) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 3 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %54 = "neura.fused_op"(%45, %31) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 4 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %56 = "neura.fused_op"(%44, %30) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 5 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %58 = "neura.fused_op"(%43, %29) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 6 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %60 = "neura.fused_op"(%42, %28) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 7 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %62 = "neura.fused_op"(%41, %27) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 8 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %64 = "neura.fused_op"(%40, %26) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 9 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %66 = "neura.fused_op"(%39, %25) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 10 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %68 = "neura.fused_op"(%38, %24) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 11 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %70 = "neura.fused_op"(%37, %23) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 12 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %72 = "neura.fused_op"(%36, %22) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 13 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %74 = "neura.fused_op"(%35, %21) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 14 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %76 = "neura.fused_op"(%34, %20) <{frequency = 60 : i64, pattern_id = 6 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->fused_op:mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<index, i1>):
          %80 = "neura.add"(%arg10) {rhs_value = 15 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %81 = neura.load_indexed [%arg11, %80 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %82 = neura.load_indexed [%80 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %83 = "neura.mul"(%81, %82) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %84 = neura.load_indexed [%arg11 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %78 = "neura.fused_op"(%19, %48) <{frequency = 64 : i64, pattern_id = 5 : i64, pattern_name = "load_indexed->add"}> ({
        ^bb0(%arg10: !neura.data<index, i1>, %arg11: !neura.data<i32, i1>):
          %80 = neura.load_indexed [%arg10 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %81 = "neura.add"(%80, %arg11) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        neura.store_indexed %79 to [%18 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %49 to [%17 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %51 to [%16 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %53 to [%15 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %55 to [%14 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %57 to [%13 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %59 to [%12 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %61 to [%11 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %63 to [%10 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %65 to [%9 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %67 to [%8 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %69 to [%7 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %71 to [%6 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %73 to [%5 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %75 to [%4 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %77 to [%3 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
  ...
  func.func @relu(%arg0: memref<4096xi32>, %arg1: memref<4096xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg2: memref<4096xi32>, %arg3: memref<4096xi32>, %arg4: i32):
      ...
      ^bb0(%arg5: memref<4096xi32>, %arg6: i32, %arg7: memref<4096xi32>):
        ...
        %18:5 = "neura.fused_op"(%16) <{frequency = 14 : i64, pattern_id = 1 : i64, pattern_name = "fused_op:constant->fused_op:fused_op:add->load_indexed->fused_op:icmp->sel->fused_op:fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ...
        %37:2 = "neura.fused_op"(%15, %32) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ...
        %40:2 = "neura.fused_op"(%14, %31) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %43:2 = "neura.fused_op"(%13, %30) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %46:2 = "neura.fused_op"(%12, %29) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %49:2 = "neura.fused_op"(%11, %28) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %52:2 = "neura.fused_op"(%10, %27) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %55:2 = "neura.fused_op"(%9, %26) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %58:2 = "neura.fused_op"(%8, %25) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %61:2 = "neura.fused_op"(%7, %24) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %64:2 = "neura.fused_op"(%6, %23) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %67:2 = "neura.fused_op"(%5, %22) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %70:2 = "neura.fused_op"(%4, %21) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
        ...
        %73:2 = "neura.fused_op"(%3, %20) <{frequency = 15 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:add->load_indexed->fused_op:icmp->sel"}> ({
        ^bb0(%arg8: !neura.data<index, i1>, %arg9: !neura.data<i32, i1>):
  ...
  func.func @add_residual(%arg0: memref<4096xi32>, %arg1: memref<4096xi32>, %arg2: memref<4096xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg3: memref<4096xi32>, %arg4: memref<4096xi32>, %arg5: memref<4096xi32>):
      ...
      ^bb0(%arg6: memref<4096xi32>, %arg7: memref<4096xi32>, %arg8: memref<4096xi32>):
        ...
        %21:2 = "neura.fused_op"(%18) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ...
        %24:2 = "neura.fused_op"(%17) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %27:2 = "neura.fused_op"(%16) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %30:2 = "neura.fused_op"(%15) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %33:2 = "neura.fused_op"(%14) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %36:2 = "neura.fused_op"(%13) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %39:2 = "neura.fused_op"(%12) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %42:2 = "neura.fused_op"(%11) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %45:2 = "neura.fused_op"(%10) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %48:2 = "neura.fused_op"(%9) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %51:2 = "neura.fused_op"(%8) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %54:2 = "neura.fused_op"(%7) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %57:2 = "neura.fused_op"(%6) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
        ...
        %60:2 = "neura.fused_op"(%5) <{frequency = 30 : i64, pattern_id = 5 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->add"}> ({
        ^bb0(%arg9: !neura.data<index, i1>):
