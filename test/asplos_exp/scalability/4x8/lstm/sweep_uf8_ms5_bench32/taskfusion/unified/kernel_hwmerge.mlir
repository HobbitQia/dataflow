  ...
  func.func @lstm_cell(%arg0: memref<32xi32>, %arg1: memref<32xi32>, %arg2: memref<32x32xi32>, %arg3: memref<32x32xi32>, %arg4: memref<32x32xi32>, %arg5: memref<32x32xi32>, %arg6: memref<32x32xi32>, %arg7: memref<32x32xi32>, %arg8: memref<32x32xi32>, %arg9: memref<32x32xi32>, %arg10: memref<32xi32>, %arg11: memref<32xi32>, %arg12: memref<32xi32>, %arg13: memref<32xi32>, %arg14: memref<32xi32>, %arg15: memref<32xi32>, %arg16: memref<32xi32>) {
    ...
    ^bb0(%arg17: memref<32xi32>, %arg18: memref<32xi32>, %arg19: memref<32x32xi32>, %arg20: memref<32xi32>):
      ...
      ^bb0(%arg21: memref<32xi32>, %arg22: memref<32xi32>, %arg23: memref<32x32xi32>):
        %2:4 = "neura.fused_op"() <{frequency = 40 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:fused_op:counter->add->add->add"}> ({
          %11 = neura.counter {counter_id = 1 : i32, counter_type = "leaf", lower_bound = 0 : index, step = 8 : index, upper_bound = 32 : index} : !neura.data<index, i1>
        ...
        ^bb0(%arg24: !neura.data<index, i1>):
          %11 = neura.counter {counter_id = 0 : i32, counter_type = "root", lower_bound = 0 : index, step = 1 : index, upper_bound = 32 : index} : !neura.data<index, i1>
    ...
    ^bb0(%arg17: memref<32xi32>, %arg18: memref<32xi32>, %arg19: memref<32xi32>, %arg20: memref<32xi32>, %arg21: memref<32xi32>, %arg22: memref<32xi32>, %arg23: memref<32xi32>):
      ...
      ^bb0(%arg24: memref<32xi32>, %arg25: memref<32xi32>, %arg26: memref<32xi32>, %arg27: memref<32xi32>, %arg28: memref<32xi32>, %arg29: memref<32xi32>):
        %1:2 = "neura.fused_op"() <{frequency = 64 : i64, pattern_id = 2 : i64, pattern_name = "counter->add"}> ({
          %13 = neura.counter {counter_id = 0 : i32, counter_type = "leaf", lower_bound = 0 : index, step = 8 : index, upper_bound = 32 : index} : !neura.data<index, i1>
          %14 = "neura.add"(%13) {rhs_value = 7 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          neura.yield results(%13, %14 : !neura.data<index, i1>, !neura.data<index, i1>)
        }) : () -> (!neura.data<index, i1>, !neura.data<index, i1>)
        %2 = "neura.fused_op"(%1#1) <{frequency = 66 : i64, pattern_id = 9 : i64, pattern_name = "load_indexed->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<index, i1>):
          %13 = neura.load_indexed [%arg30 : !neura.data<index, i1>]  {lhs_value = "%input3"} : !neura.data<i32, i1>
          %14 = neura.load_indexed [%arg30 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %15 = "neura.mul"(%14, %13) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%15 : !neura.data<i32, i1>)
        }) : (!neura.data<index, i1>) -> !neura.data<i32, i1>
        %3 = "neura.fused_op"(%1#1) <{frequency = 66 : i64, pattern_id = 9 : i64, pattern_name = "load_indexed->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<index, i1>):
          %13 = neura.load_indexed [%arg30 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %14 = neura.load_indexed [%arg30 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %15 = "neura.mul"(%14, %13) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%15 : !neura.data<i32, i1>)
        }) : (!neura.data<index, i1>) -> !neura.data<i32, i1>
        ...
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<i32, i1>):
          %13 = "neura.add"(%arg30, %arg31) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %14 = "neura.mul"(%13, %13) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %15 = "neura.mul"(%13, %13) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%13, %14, %15 : !neura.data<i32, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>)
        }) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> (!neura.data<i32, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>)
        %5:2 = "neura.fused_op"(%4#0, %1#0) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %13 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %14 = "neura.add"(%arg31) {rhs_value = 7 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        ...
        %6:2 = "neura.fused_op"(%4#0, %1#0) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %13 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %14 = "neura.add"(%arg31) {rhs_value = 6 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %15 = neura.load_indexed [%14 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %16 = "neura.mul"(%15, %13) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%14, %16 : !neura.data<index, i1>, !neura.data<i32, i1>)
        }) : (!neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<index, i1>, !neura.data<i32, i1>)
        %7:2 = "neura.fused_op"(%4#0, %1#0) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %13 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %14 = "neura.add"(%arg31) {rhs_value = 5 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %15 = neura.load_indexed [%14 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %16 = "neura.mul"(%15, %13) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%14, %16 : !neura.data<index, i1>, !neura.data<i32, i1>)
        }) : (!neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<index, i1>, !neura.data<i32, i1>)
        %8:2 = "neura.fused_op"(%4#0, %1#0) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %13 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %14 = "neura.add"(%arg31) {rhs_value = 4 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %15 = neura.load_indexed [%14 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %16 = "neura.mul"(%15, %13) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%14, %16 : !neura.data<index, i1>, !neura.data<i32, i1>)
        }) : (!neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<index, i1>, !neura.data<i32, i1>)
        %9:2 = "neura.fused_op"(%4#0, %1#0) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %13 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %14 = "neura.add"(%arg31) {rhs_value = 3 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %15 = neura.load_indexed [%14 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %16 = "neura.mul"(%15, %13) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%14, %16 : !neura.data<index, i1>, !neura.data<i32, i1>)
        }) : (!neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<index, i1>, !neura.data<i32, i1>)
        %10:2 = "neura.fused_op"(%4#0, %1#0) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %13 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %14 = "neura.add"(%arg31) {rhs_value = 2 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %15 = neura.load_indexed [%14 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %16 = "neura.mul"(%15, %13) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%14, %16 : !neura.data<index, i1>, !neura.data<i32, i1>)
        }) : (!neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<index, i1>, !neura.data<i32, i1>)
        %11 = "neura.fused_op"(%1#0, %4#1) <{frequency = 140 : i64, pattern_id = 5 : i64, pattern_name = "load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<index, i1>, %arg31: !neura.data<i32, i1>):
          %13 = neura.load_indexed [%arg30 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %11 to [%1#0 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        %12:2 = "neura.fused_op"(%1#0, %4#2) <{frequency = 55 : i64, pattern_id = 0 : i64, pattern_name = "add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<index, i1>, %arg31: !neura.data<i32, i1>):
          %13 = "neura.add"(%arg30) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
