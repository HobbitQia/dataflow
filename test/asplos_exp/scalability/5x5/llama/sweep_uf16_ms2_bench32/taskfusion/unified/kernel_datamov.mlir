    ...
    ^bb0(%arg14: memref<32xi32>, %arg15: memref<32xi32>, %arg16: memref<32xi32>):
      ...
      ^bb0(%arg17: memref<32xi32>, %arg18: memref<32xi32>, %arg19: memref<32xi32>):
        %2:4 = "neura.fused_op"() <{frequency = 15 : i64, pattern_id = 10 : i64, pattern_name = "fused_op:fused_op:counter->load_indexed->fused_op:load_indexed->mul->fused_op:fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
          ...
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %66 = "neura.mul"(%65, %64) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %67 = "neura.add"(%63) {rhs_value = 15 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %68 = neura.load_indexed [%67 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          ...
          neura.yield results(%63, %66, %67, %70 : !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<index, i1>, !neura.data<i32, i1>)
        }) {latency = 2 : i32} : () -> (!neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<index, i1>, !neura.data<i32, i1>)
        %3 = "neura.data_mov"(%2#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %4 = "neura.data_mov"(%2#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %5 = "neura.data_mov"(%2#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        ...
        %16 = "neura.data_mov"(%2#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %17 = "neura.data_mov"(%2#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %18 = "neura.data_mov"(%2#1) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %19 = "neura.data_mov"(%2#2) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %20 = "neura.data_mov"(%2#3) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %21:2 = "neura.fused_op"(%17) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 14 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %24:2 = "neura.fused_op"(%16) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 13 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %27:2 = "neura.fused_op"(%15) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 12 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %30:2 = "neura.fused_op"(%14) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 11 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %33:2 = "neura.fused_op"(%13) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 10 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %36:2 = "neura.fused_op"(%12) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 9 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %39:2 = "neura.fused_op"(%11) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 8 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %42:2 = "neura.fused_op"(%10) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 7 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %45:2 = "neura.fused_op"(%9) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 6 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %48:2 = "neura.fused_op"(%8) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 5 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %51:2 = "neura.fused_op"(%7) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 4 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %54:2 = "neura.fused_op"(%6) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 3 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        %57:2 = "neura.fused_op"(%5) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 2 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %66 = "neura.mul"(%64, %65) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%63, %66 : !neura.data<index, i1>, !neura.data<i32, i1>)
        ...
        %60:2 = "neura.fused_op"(%4) <{frequency = 30 : i64, pattern_id = 9 : i64, pattern_name = "fused_op:fused_op:add->load_indexed->load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
          %63 = "neura.add"(%arg20) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %64 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
          %65 = neura.load_indexed [%63 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %66 = "neura.mul"(%64, %65) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%63, %66 : !neura.data<index, i1>, !neura.data<i32, i1>)
