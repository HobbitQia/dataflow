    ...
    ^bb0(%arg17: memref<32xi32>, %arg18: memref<32xi32>, %arg19: memref<32xi32>, %arg20: memref<32xi32>, %arg21: memref<32xi32>, %arg22: memref<32xi32>, %arg23: memref<32xi32>):
      ...
      ^bb0(%arg24: memref<32xi32>, %arg25: memref<32xi32>, %arg26: memref<32xi32>, %arg27: memref<32xi32>, %arg28: memref<32xi32>, %arg29: memref<32xi32>):
        %1:2 = "neura.fused_op"() <{frequency = 64 : i64, pattern_id = 2 : i64, pattern_name = "counter->add"}> ({
          %49 = neura.counter {counter_id = 0 : i32, counter_type = "leaf", lower_bound = 0 : index, step = 8 : index, upper_bound = 32 : index} : !neura.data<index, i1>
          %50 = "neura.add"(%49) {rhs_value = 7 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        ...
        ^bb0(%arg30: !neura.data<index, i1>):
          %49 = neura.load_indexed [%arg30 : !neura.data<index, i1>]  {lhs_value = "%input3"} : !neura.data<i32, i1>
          %50 = neura.load_indexed [%arg30 : !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %51 = "neura.mul"(%50, %49) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        ^bb0(%arg30: !neura.data<index, i1>):
          %49 = neura.load_indexed [%arg30 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        ...
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<i32, i1>):
          %49 = "neura.add"(%arg30, %arg31) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %50 = "neura.mul"(%49, %49) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %51 = "neura.mul"(%49, %49) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%49, %50, %51 : !neura.data<i32, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>)
        ...
        %24 = "neura.data_mov"(%17#1) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %25 = "neura.data_mov"(%17#2) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %26:2 = "neura.fused_op"(%23, %10) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %49 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %50 = "neura.add"(%arg31) {rhs_value = 7 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %51 = neura.load_indexed [%50 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %52 = "neura.mul"(%51, %49) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        %29:2 = "neura.fused_op"(%22, %9) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %49 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %50 = "neura.add"(%arg31) {rhs_value = 6 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %51 = neura.load_indexed [%50 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %52 = "neura.mul"(%51, %49) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%50, %52 : !neura.data<index, i1>, !neura.data<i32, i1>)
        }) {latency = 2 : i32} : (!neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<index, i1>, !neura.data<i32, i1>)
        ...
        %32:2 = "neura.fused_op"(%21, %8) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %49 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %50 = "neura.add"(%arg31) {rhs_value = 5 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %51 = neura.load_indexed [%50 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %52 = "neura.mul"(%51, %49) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%50, %52 : !neura.data<index, i1>, !neura.data<i32, i1>)
        }) {latency = 2 : i32} : (!neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<index, i1>, !neura.data<i32, i1>)
        ...
        %35:2 = "neura.fused_op"(%20, %7) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %49 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %50 = "neura.add"(%arg31) {rhs_value = 4 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %51 = neura.load_indexed [%50 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %52 = "neura.mul"(%51, %49) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%50, %52 : !neura.data<index, i1>, !neura.data<i32, i1>)
        }) {latency = 2 : i32} : (!neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<index, i1>, !neura.data<i32, i1>)
        ...
        %38:2 = "neura.fused_op"(%19, %6) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %49 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %50 = "neura.add"(%arg31) {rhs_value = 3 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %51 = neura.load_indexed [%50 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %52 = "neura.mul"(%51, %49) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%50, %52 : !neura.data<index, i1>, !neura.data<i32, i1>)
        }) {latency = 2 : i32} : (!neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<index, i1>, !neura.data<i32, i1>)
        ...
        %41:2 = "neura.fused_op"(%18, %5) <{frequency = 6 : i64, pattern_id = 7 : i64, pattern_name = "mul->fused_op:add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<index, i1>):
          %49 = "neura.mul"(%arg30, %arg30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %50 = "neura.add"(%arg31) {rhs_value = 2 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %51 = neura.load_indexed [%50 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %52 = "neura.mul"(%51, %49) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%50, %52 : !neura.data<index, i1>, !neura.data<i32, i1>)
        }) {latency = 2 : i32} : (!neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<index, i1>, !neura.data<i32, i1>)
        ...
        %44 = "neura.fused_op"(%4, %24) <{frequency = 140 : i64, pattern_id = 5 : i64, pattern_name = "load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<index, i1>, %arg31: !neura.data<i32, i1>):
          %49 = neura.load_indexed [%arg30 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %50 = "neura.mul"(%49, %arg31) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        neura.store_indexed %45 to [%3 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        %46:2 = "neura.fused_op"(%2, %25) <{frequency = 55 : i64, pattern_id = 0 : i64, pattern_name = "add->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<index, i1>, %arg31: !neura.data<i32, i1>):
          %49 = "neura.add"(%arg30) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %50 = neura.load_indexed [%49 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %51 = "neura.mul"(%50, %arg31) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%49, %51 : !neura.data<index, i1>, !neura.data<i32, i1>)
        ...
        neura.store_indexed %48 to [%47 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.store_indexed %43 to [%42 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %28 to [%27 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.yield {latency = 1 : i32, yield_type = "void"}
      }
