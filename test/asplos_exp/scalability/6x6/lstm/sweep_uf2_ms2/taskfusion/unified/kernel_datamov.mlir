  ...
  func.func @lstm_cell(%arg0: memref<16xi32>, %arg1: memref<16xi32>, %arg2: memref<16x16xi32>, %arg3: memref<16x16xi32>, %arg4: memref<16x16xi32>, %arg5: memref<16x16xi32>, %arg6: memref<16x16xi32>, %arg7: memref<16x16xi32>, %arg8: memref<16x16xi32>, %arg9: memref<16x16xi32>, %arg10: memref<16xi32>, %arg11: memref<16xi32>, %arg12: memref<16xi32>, %arg13: memref<16xi32>, %arg14: memref<16xi32>, %arg15: memref<16xi32>, %arg16: memref<16xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg17: memref<16xi32>, %arg18: memref<16xi32>, %arg19: memref<16x16xi32>, %arg20: memref<16xi32>):
      ...
      ^bb0(%arg21: memref<16xi32>, %arg22: memref<16xi32>, %arg23: memref<16x16xi32>):
        %2:4 = "neura.fused_op"() <{frequency = 8 : i64, pattern_id = 0 : i64, pattern_name = "fused_op:counter->load_indexed->fused_op:fused_op:counter->add->fused_op:load_indexed->fused_op:load_indexed->mul"}> ({
        ...
        %10 = "neura.fused_op"(%6, %8, %7) <{frequency = 8 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:load_indexed->fused_op:load_indexed->mul->add"}> ({
        ^bb0(%arg24: !neura.data<index, i1>, %arg25: !neura.data<index, i1>, %arg26: !neura.data<i32, i1>):
          ...
          %17 = "neura.add"(%arg26, %16) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        %12 = "neura.fused_op"(%4, %9) <{frequency = 16 : i64, pattern_id = 4 : i64, pattern_name = "load_indexed->add"}> ({
        ^bb0(%arg24: !neura.data<index, i1>, %arg25: !neura.data<i32, i1>):
          ...
          %15 = "neura.add"(%14, %arg25) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
    ...
    ^bb0(%arg17: memref<16xi32>, %arg18: memref<16xi32>, %arg19: memref<16xi32>, %arg20: memref<16xi32>, %arg21: memref<16xi32>, %arg22: memref<16xi32>, %arg23: memref<16xi32>):
      ...
      ^bb0(%arg24: memref<16xi32>, %arg25: memref<16xi32>, %arg26: memref<16xi32>, %arg27: memref<16xi32>, %arg28: memref<16xi32>, %arg29: memref<16xi32>):
        %1:3 = "neura.fused_op"() <{frequency = 18 : i64, pattern_id = 0 : i64, pattern_name = "fused_op:counter->add->fused_op:load_indexed->fused_op:load_indexed->mul"}> ({
          ...
          %19 = neura.load_indexed [%18 : !neura.data<index, i1>]  {lhs_value = "%input3"} : !neura.data<i32, i1>
          ...
          neura.yield results(%17, %18, %21 : !neura.data<index, i1>, !neura.data<index, i1>, !neura.data<i32, i1>)
        ...
        %7 = "neura.fused_op"(%5) <{frequency = 18 : i64, pattern_id = 9 : i64, pattern_name = "load_indexed->fused_op:load_indexed->mul"}> ({
        ...
        %9:2 = "neura.fused_op"(%8, %6, %4) <{frequency = 2 : i64, pattern_id = 3 : i64, pattern_name = "fused_op:fused_op:add->mul->mul->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg30: !neura.data<i32, i1>, %arg31: !neura.data<i32, i1>, %arg32: !neura.data<index, i1>):
          ...
          %20 = neura.load_indexed [%arg32 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        ...
        }) {latency = 2 : i32} : (!neura.data<i32, i1>, !neura.data<i32, i1>, !neura.data<index, i1>) -> (!neura.data<i32, i1>, !neura.data<i32, i1>)
        ...
        %12 = "neura.add"(%2) {latency = 1 : i32, rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %13 = "neura.data_mov"(%12) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %14 = "neura.fused_op"(%13, %10) <{frequency = 38 : i64, pattern_id = 5 : i64, pattern_name = "load_indexed->mul"}> ({
        ...
        neura.store_indexed %15 to [%16 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.yield {latency = 1 : i32, yield_type = "void"}
      }
