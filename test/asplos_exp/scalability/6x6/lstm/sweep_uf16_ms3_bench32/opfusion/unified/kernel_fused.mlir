  ...
  func.func @cell_update(%arg0: memref<32xi32>, %arg1: memref<32xi32>, %arg2: memref<32xi32>, %arg3: memref<32xi32>, %arg4: memref<32xi32>) {
    ...
    ^bb0(%arg5: memref<32xi32>, %arg6: memref<32xi32>, %arg7: memref<32xi32>, %arg8: memref<32xi32>, %arg9: memref<32xi32>):
      ...
      ^bb0(%arg10: memref<32xi32>, %arg11: memref<32xi32>, %arg12: memref<32xi32>, %arg13: memref<32xi32>, %arg14: memref<32xi32>):
        ...
        neura.store_indexed %16 to [%1#0 : !neura.data<index, i1>]  {rhs_value = "%input4"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %18 to [%1#2 : !neura.data<index, i1>]  {rhs_value = "%input4"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %7#1 to [%7#0 : !neura.data<index, i1>]  {rhs_value = "%input4"} : !neura.data<i32, i1>
        neura.store_indexed %8#1 to [%8#0 : !neura.data<index, i1>]  {rhs_value = "%input4"} : !neura.data<i32, i1>
        neura.store_indexed %9#1 to [%9#0 : !neura.data<index, i1>]  {rhs_value = "%input4"} : !neura.data<i32, i1>
        neura.store_indexed %10#1 to [%10#0 : !neura.data<index, i1>]  {rhs_value = "%input4"} : !neura.data<i32, i1>
        neura.store_indexed %11#1 to [%11#0 : !neura.data<index, i1>]  {rhs_value = "%input4"} : !neura.data<i32, i1>
        neura.store_indexed %12#1 to [%12#0 : !neura.data<index, i1>]  {rhs_value = "%input4"} : !neura.data<i32, i1>
        neura.store_indexed %13#1 to [%13#0 : !neura.data<index, i1>]  {rhs_value = "%input4"} : !neura.data<i32, i1>
        neura.store_indexed %14#1 to [%14#0 : !neura.data<index, i1>]  {rhs_value = "%input4"} : !neura.data<i32, i1>
        neura.yield {yield_type = "void"}
      }
  ...
  func.func @output_gate(%arg0: memref<32xi32>, %arg1: memref<32xi32>, %arg2: memref<32xi32>) {
    ...
    ^bb0(%arg3: memref<32xi32>, %arg4: memref<32xi32>, %arg5: memref<32xi32>):
      ...
      ^bb0(%arg6: memref<32xi32>, %arg7: memref<32xi32>, %arg8: memref<32xi32>):
        ...
        neura.store_indexed %15 to [%1#1 : !neura.data<index, i1>]  {rhs_value = "%input2"} : !neura.data<i32, i1>
