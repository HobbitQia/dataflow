  ...
  func.func @lstm_cell(%arg0: memref<32xi32>, %arg1: memref<32xi32>, %arg2: memref<32x32xi32>, %arg3: memref<32x32xi32>, %arg4: memref<32x32xi32>, %arg5: memref<32x32xi32>, %arg6: memref<32x32xi32>, %arg7: memref<32x32xi32>, %arg8: memref<32x32xi32>, %arg9: memref<32x32xi32>, %arg10: memref<32xi32>, %arg11: memref<32xi32>, %arg12: memref<32xi32>, %arg13: memref<32xi32>, %arg14: memref<32xi32>, %arg15: memref<32xi32>, %arg16: memref<32xi32>) {
    ...
    ^bb0(%arg17: memref<32xi32>, %arg18: memref<32xi32>, %arg19: memref<32xi32>, %arg20: memref<32xi32>, %arg21: memref<32xi32>, %arg22: memref<32xi32>, %arg23: memref<32xi32>):
      ...
      ^bb0(%arg24: memref<32xi32>, %arg25: memref<32xi32>, %arg26: memref<32xi32>, %arg27: memref<32xi32>, %arg28: memref<32xi32>, %arg29: memref<32xi32>):
        ...
        %2 = "neura.add"(%1) {rhs_value = 15 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        ...
        %42 = neura.load_indexed [%41 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        %43 = "neura.mul"(%9, %9) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %44 = "neura.mul"(%42, %43) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        neura.store_indexed %44 to [%41 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        %45 = "neura.add"(%1) {rhs_value = 9 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %46 = neura.load_indexed [%45 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        %47 = "neura.mul"(%9, %9) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %48 = "neura.mul"(%46, %47) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        neura.store_indexed %48 to [%45 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        %49 = "neura.add"(%1) {rhs_value = 10 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %50 = neura.load_indexed [%49 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        %51 = "neura.mul"(%9, %9) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %52 = "neura.mul"(%50, %51) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        neura.store_indexed %52 to [%49 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        %53 = "neura.add"(%1) {rhs_value = 11 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %54 = neura.load_indexed [%53 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        %55 = "neura.mul"(%9, %9) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %56 = "neura.mul"(%54, %55) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        neura.store_indexed %56 to [%53 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        %57 = "neura.add"(%1) {rhs_value = 12 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %58 = neura.load_indexed [%57 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        %59 = "neura.mul"(%9, %9) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %60 = "neura.mul"(%58, %59) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        neura.store_indexed %60 to [%57 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        %61 = "neura.add"(%1) {rhs_value = 13 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %62 = neura.load_indexed [%61 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        %63 = "neura.mul"(%9, %9) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %64 = "neura.mul"(%62, %63) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        neura.store_indexed %64 to [%61 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        %65 = "neura.add"(%1) {rhs_value = 14 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %66 = neura.load_indexed [%65 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        %67 = "neura.mul"(%9, %9) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %68 = "neura.mul"(%66, %67) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        neura.store_indexed %68 to [%65 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        %69 = "neura.add"(%1) {rhs_value = 15 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %70 = neura.load_indexed [%69 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        %71 = "neura.mul"(%9, %9) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %72 = "neura.mul"(%70, %71) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        neura.store_indexed %72 to [%69 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.yield {yield_type = "void"}
      }
