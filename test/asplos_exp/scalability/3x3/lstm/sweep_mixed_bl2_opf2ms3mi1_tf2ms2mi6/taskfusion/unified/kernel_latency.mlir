    ...
    ^bb0(%arg17: memref<16xi32>, %arg18: memref<16xi32>, %arg19: memref<16x16xi32>, %arg20: memref<16xi32>, %arg21: memref<16x16xi32>, %arg22: memref<16xi32>, %arg23: memref<16xi32>):
      ...
      ^bb0(%arg24: memref<16xi32>, %arg25: memref<16xi32>, %arg26: memref<16x16xi32>, %arg27: memref<16xi32>, %arg28: memref<16x16xi32>):
        %2:5 = "neura.fused_op"() <{frequency = 4 : i64, pattern_id = 1 : i64, pattern_name = "fused_op:fused_op:counter->add->add->fused_op:fused_op:counter->fused_op:fused_op:load_indexed->fused_op:load_indexed->mul->fused_op:load_indexed->add->fused_op:fused_op:load_indexed->fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
          ...
          %9 = neura.load_indexed [%8, %7 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %10 = neura.load_indexed [%7 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          ...
          %14 = neura.load_indexed [%8, %5 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %15 = neura.load_indexed [%5 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %16 = "neura.mul"(%15, %14) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %17 = neura.load_indexed [%8 : !neura.data<index, i1>]  {lhs_value = "%input3"} : !neura.data<i32, i1>
          %18 = "neura.add"(%17, %16) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%5, %6, %8, %13, %18 : !neura.data<index, i1>, !neura.data<index, i1>, !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>)
        }) {latency = 2 : i32} : () -> (!neura.data<index, i1>, !neura.data<index, i1>, !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>)
        %3 = "neura.fused_op"(%2#2, %2#1) <{frequency = 16 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:load_indexed->fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg29: !neura.data<index, i1>, %arg30: !neura.data<index, i1>):
          %5 = neura.load_indexed [%arg29, %arg30 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          ...
          %8 = neura.load_indexed [%arg29 : !neura.data<index, i1>]  {lhs_value = "%input0"} : !neura.data<i32, i1>
        ...
        %4 = "neura.fused_op"(%2#2, %2#0) <{frequency = 16 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:load_indexed->fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg29: !neura.data<index, i1>, %arg30: !neura.data<index, i1>):
          %5 = neura.load_indexed [%arg29, %arg30 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          %6 = neura.load_indexed [%arg30 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
          %7 = "neura.mul"(%6, %5) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        neura.store_indexed %4 to [%2#2 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %3 to [%2#2 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.store_indexed %2#4 to [%2#2 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input3"} : !neura.data<i32, i1>
        neura.store_indexed %2#3 to [%2#2 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input3"} : !neura.data<i32, i1>
    ...
    ^bb0(%arg17: memref<16xi32>, %arg18: memref<16xi32>, %arg19: memref<16xi32>, %arg20: memref<16xi32>, %arg21: memref<16xi32>, %arg22: memref<16xi32>, %arg23: memref<16xi32>):
      ...
      ^bb0(%arg24: memref<16xi32>, %arg25: memref<16xi32>, %arg26: memref<16xi32>, %arg27: memref<16xi32>, %arg28: memref<16xi32>, %arg29: memref<16xi32>):
        %1:4 = "neura.fused_op"() <{frequency = 2 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:fused_op:fused_op:fused_op:counter->add->fused_op:load_indexed->fused_op:load_indexed->mul->fused_op:fused_op:load_indexed->fused_op:load_indexed->mul->fused_op:fused_op:add->mul->mul->fused_op:add->fused_op:load_indexed->mul->fused_op:load_indexed->mul"}> ({
          ...
          %16 = neura.load_indexed [%2 : !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %17 = "neura.mul"(%16, %11) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%2, %13, %15, %17 : !neura.data<index, i1>, !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>)
        }) {latency = 3 : i32} : () -> (!neura.data<index, i1>, !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>)
        neura.store_indexed %1#3 to [%1#0 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.store_indexed %1#2 to [%1#1 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.yield {latency = 1 : i32, yield_type = "void"}
      }
