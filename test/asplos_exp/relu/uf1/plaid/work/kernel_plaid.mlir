module attributes {dlti.dl_spec = #dlti.dl_spec<i64 = dense<64> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, i32 = dense<32> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i8 = dense<8> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, llvm.ident = "Ubuntu clang version 14.0.0-1ubuntu1.1"} {
  ...
  func.func @_Z6kernelPiS_(%arg0: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.readonly}, %arg1: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.writeonly}) -> !llvm.void attributes {CConv = #llvm.cconv<ccc>, accelerator = "neura", dataflow_mode = "predicate", frame_pointer = #llvm.framePointerKind<none>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, visibility_ = 0 : i64} {
    ...
    %plaid_fused_0:2 = "neura.fused_op"(%43, %41, %39) <{frequency = 1 : i64, pattern_id = 0 : i64, pattern_name = "plaid.unicast:add->gep->load"}> ({
    ^bb0(%plaid_arg1_0: !neura.data<i64, i1>, %plaid_arg1_1: !neura.data<i64, i1>, %plaid_arg1_2: !neura.data<!llvm.ptr, i1>):
      %44 = "neura.add"(%plaid_arg1_0, %plaid_arg1_1) : (!neura.data<i64, i1>, !neura.data<i64, i1>) -> !neura.data<i64, i1>
      %45 = "neura.gep"(%plaid_arg1_2, %44) <{operandSegmentSizes = array<i32: 1, 1>}> : (!neura.data<!llvm.ptr, i1>, !neura.data<i64, i1>) -> !neura.data<!llvm.ptr, i1>
      %46 = "neura.load"(%45) : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
      neura.yield results(%44, %46 : !neura.data<i64, i1>, !neura.data<i32, i1>)
    }) : (!neura.data<i64, i1>, !neura.data<i64, i1>, !neura.data<!llvm.ptr, i1>) -> (!neura.data<i64, i1>, !neura.data<i32, i1>)
    %47 = "neura.icmp"(%plaid_fused_0#1, %37) <{cmpType = "sgt"}> : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i1, i1>
    %48 = "neura.sel"(%47, %plaid_fused_0#1, %37) : (!neura.data<i1, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
    %49 = "neura.gep"(%35, %plaid_fused_0#0) <{operandSegmentSizes = array<i32: 1, 1>}> : (!neura.data<!llvm.ptr, i1>, !neura.data<i64, i1>) -> !neura.data<!llvm.ptr, i1>
    "neura.store"(%48, %49) : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
    %plaid_fused_1:3 = "neura.fused_op"(%43, %33, %31) <{frequency = 1 : i64, pattern_id = 1 : i64, pattern_name = "plaid.unicast:add->icmp->not"}> ({
    ^bb0(%plaid_arg2_0: !neura.data<i64, i1>, %plaid_arg2_1: !neura.data<i64, i1>, %plaid_arg2_2: !neura.data<i64, i1>):
      %50 = "neura.add"(%plaid_arg2_0, %plaid_arg2_1) : (!neura.data<i64, i1>, !neura.data<i64, i1>) -> !neura.data<i64, i1>
      %51 = "neura.icmp"(%50, %plaid_arg2_2) <{cmpType = "eq"}> : (!neura.data<i64, i1>, !neura.data<i64, i1>) -> !neura.data<i1, i1>
      %52 = "neura.not"(%51) : (!neura.data<i1, i1>) -> !neura.data<i1, i1>
      neura.yield results(%50, %51, %52 : !neura.data<i64, i1>, !neura.data<i1, i1>, !neura.data<i1, i1>)
    }) : (!neura.data<i64, i1>, !neura.data<i64, i1>, !neura.data<i64, i1>) -> (!neura.data<i64, i1>, !neura.data<i1, i1>, !neura.data<i1, i1>)
    %53 = neura.grant_predicate %plaid_fused_1#0, %plaid_fused_1#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %53 -> %42 : !neura.data<i64, i1> !neura.data<i64, i1>
    %54 = neura.grant_predicate %41, %plaid_fused_1#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %54 -> %40 : !neura.data<i64, i1> !neura.data<i64, i1>
    %55 = neura.grant_predicate %39, %plaid_fused_1#2 : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %55 -> %38 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    %56 = neura.grant_predicate %37, %plaid_fused_1#2 : !neura.data<i32, i1>, !neura.data<i1, i1> -> !neura.data<i32, i1>
    neura.ctrl_mov %56 -> %36 : !neura.data<i32, i1> !neura.data<i32, i1>
    %57 = neura.grant_predicate %35, %plaid_fused_1#2 : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %57 -> %34 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    %58 = neura.grant_predicate %33, %plaid_fused_1#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %58 -> %32 : !neura.data<i64, i1> !neura.data<i64, i1>
    %59 = neura.grant_predicate %31, %plaid_fused_1#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %59 -> %30 : !neura.data<i64, i1> !neura.data<i64, i1>
    %60 = neura.grant_predicate %29, %plaid_fused_1#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %60 -> %28 : !neura.data<i64, i1> !neura.data<i64, i1>
    %61 = neura.grant_predicate %27, %plaid_fused_1#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %61 -> %26 : !neura.data<i64, i1> !neura.data<i64, i1>
    %62 = neura.grant_predicate %25, %plaid_fused_1#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %62 -> %24 : !neura.data<i64, i1> !neura.data<i64, i1>
    %63 = neura.grant_predicate %29, %plaid_fused_1#1 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    %64 = neura.grant_predicate %33, %plaid_fused_1#1 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    %65 = neura.grant_predicate %31, %plaid_fused_1#1 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    %66 = neura.grant_predicate %27, %plaid_fused_1#1 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    %67 = neura.grant_predicate %25, %plaid_fused_1#1 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    %68 = neura.grant_predicate %39, %plaid_fused_1#1 : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
    %69 = neura.grant_predicate %37, %plaid_fused_1#1 : !neura.data<i32, i1>, !neura.data<i1, i1> -> !neura.data<i32, i1>
    %70 = neura.grant_predicate %35, %plaid_fused_1#1 : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
    %plaid_fused_2:3 = "neura.fused_op"(%63, %64, %65) <{frequency = 1 : i64, pattern_id = 2 : i64, pattern_name = "plaid.unicast:add->icmp->not"}> ({
    ^bb0(%plaid_arg3_0: !neura.data<i64, i1>, %plaid_arg3_1: !neura.data<i64, i1>, %plaid_arg3_2: !neura.data<i64, i1>):
      ...
      %72 = "neura.icmp"(%71, %plaid_arg3_2) <{cmpType = "eq"}> : (!neura.data<i64, i1>, !neura.data<i64, i1>) -> !neura.data<i1, i1>
      %73 = "neura.not"(%72) : (!neura.data<i1, i1>) -> !neura.data<i1, i1>
      neura.yield results(%71, %72, %73 : !neura.data<i64, i1>, !neura.data<i1, i1>, !neura.data<i1, i1>)
    }) : (!neura.data<i64, i1>, !neura.data<i64, i1>, !neura.data<i64, i1>) -> (!neura.data<i64, i1>, !neura.data<i1, i1>, !neura.data<i1, i1>)
    %74 = neura.grant_predicate %plaid_fused_2#0, %plaid_fused_2#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %74 -> %21 : !neura.data<i64, i1> !neura.data<i64, i1>
    %75 = neura.grant_predicate %66, %plaid_fused_2#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %75 -> %19 : !neura.data<i64, i1> !neura.data<i64, i1>
    %76 = neura.grant_predicate %67, %plaid_fused_2#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %76 -> %17 : !neura.data<i64, i1> !neura.data<i64, i1>
    %77 = neura.grant_predicate %68, %plaid_fused_2#2 : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %77 -> %15 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    %78 = neura.grant_predicate %69, %plaid_fused_2#2 : !neura.data<i32, i1>, !neura.data<i1, i1> -> !neura.data<i32, i1>
    neura.ctrl_mov %78 -> %13 : !neura.data<i32, i1> !neura.data<i32, i1>
    %79 = neura.grant_predicate %70, %plaid_fused_2#2 : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %79 -> %11 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    %80 = neura.grant_predicate %64, %plaid_fused_2#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %80 -> %9 : !neura.data<i64, i1> !neura.data<i64, i1>
    %81 = neura.grant_predicate %65, %plaid_fused_2#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %81 -> %7 : !neura.data<i64, i1> !neura.data<i64, i1>
    %82 = neura.grant_predicate %plaid_fused_2#1, %plaid_fused_2#1 : !neura.data<i1, i1>, !neura.data<i1, i1> -> !neura.data<i1, i1>
