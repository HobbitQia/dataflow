  ...
  func.func @ffn_act(%arg0: memref<16xi32>, %arg1: memref<16xi32>, %arg2: memref<16xi32>) {
    ...
    ^bb0(%arg3: memref<16xi32>, %arg4: memref<16xi32>, %arg5: memref<16xi32>):
      ...
      ^bb0(%arg6: memref<16xi32>, %arg7: memref<16xi32>, %arg8: memref<16xi32>):
        ...
        %8 = "neura.mul"(%plaid_fused_1#1, %plaid_fused_1#2) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        ...
        %16 = "neura.mul"(%plaid_fused_3#1, %plaid_fused_3#2) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
  ...
  func.func @softmax_norm(%arg0: memref<16xi32>, %arg1: memref<1xi32>) {
    ...
    ^bb0(%arg2: memref<16xi32>, %arg3: memref<16xi32>, %arg4: i32):
      ...
      ^bb0(%arg5: memref<16xi32>, %arg6: i32):
        ...
        %plaid_fused_2:2 = "neura.fused_op"(%plaid_fused_0#0) <{frequency = 1 : i64, pattern_id = 2 : i64, pattern_name = "plaid.unicast:add->load_indexed->div"}> ({
        ^bb0(%plaid_arg3_0: !neura.data<index, i1>):
          %8 = "neura.add"(%plaid_arg3_0) {rhs_value = 2 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        ...
        neura.store_indexed %plaid_fused_2#1 to [%plaid_fused_2#0 : !neura.data<index, i1>]  {rhs_value = "%input0"} : !neura.data<i32, i1>
        %plaid_fused_3:2 = "neura.fused_op"(%plaid_fused_0#0) <{frequency = 1 : i64, pattern_id = 3 : i64, pattern_name = "plaid.unicast:add->load_indexed->div"}> ({
        ^bb0(%plaid_arg4_0: !neura.data<index, i1>):
          %11 = "neura.add"(%plaid_arg4_0) {rhs_value = 3 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        ...
        neura.store_indexed %plaid_fused_3#1 to [%plaid_fused_3#0 : !neura.data<index, i1>]  {rhs_value = "%input0"} : !neura.data<i32, i1>
        neura.yield {yield_type = "void"}
      }
