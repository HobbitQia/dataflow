...
module attributes {dlti.dl_spec = #dlti.dl_spec<i32 = dense<32> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, llvm.ident = "Ubuntu clang version 14.0.0-1ubuntu1.1"} {
  ...
  func.func @_Z6kernelPiPKi(%arg0: !llvm.ptr {llvm.nocapture, llvm.noundef}, %arg1: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.readonly}) -> !llvm.void attributes {CConv = #llvm.cconv<ccc>, accelerator = "neura", dataflow_mode = "predicate", frame_pointer = #llvm.framePointerKind<none>, linkage = #llvm.linkage<external>, no_unwind, passthrough = ["mustprogress", "nofree", "norecurse", "nosync", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, visibility_ = 0 : i64} {
    ...
    %plaid_fused_0:2 = "neura.fused_op"(%27, %25, %23) <{frequency = 1 : i64, pattern_id = 0 : i64, pattern_name = "plaid.unicast:shl->gep->load"}> ({
    ^bb0(%plaid_arg1_0: !neura.data<i64, i1>, %plaid_arg1_1: !neura.data<i64, i1>, %plaid_arg1_2: !neura.data<!llvm.ptr, i1>):
      %32 = "neura.shl"(%plaid_arg1_0, %plaid_arg1_1) : (!neura.data<i64, i1>, !neura.data<i64, i1>) -> !neura.data<i64, i1>
      %33 = "neura.gep"(%plaid_arg1_2, %32) <{operandSegmentSizes = array<i32: 1, 1>}> : (!neura.data<!llvm.ptr, i1>, !neura.data<i64, i1>) -> !neura.data<!llvm.ptr, i1>
      %34 = "neura.load"(%33) : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
      neura.yield results(%32, %34 : !neura.data<i64, i1>, !neura.data<i32, i1>)
    }) : (!neura.data<i64, i1>, !neura.data<i64, i1>, !neura.data<!llvm.ptr, i1>) -> (!neura.data<i64, i1>, !neura.data<i32, i1>)
    %plaid_fused_1 = "neura.fused_op"(%plaid_fused_0#0, %25, %23) <{frequency = 1 : i64, pattern_id = 1 : i64, pattern_name = "plaid.unicast:or->gep->load"}> ({
    ^bb0(%plaid_arg2_0: !neura.data<i64, i1>, %plaid_arg2_1: !neura.data<i64, i1>, %plaid_arg2_2: !neura.data<!llvm.ptr, i1>):
      %35 = "neura.or"(%plaid_arg2_0, %plaid_arg2_1) : (!neura.data<i64, i1>, !neura.data<i64, i1>) -> !neura.data<i64, i1>
      %36 = "neura.gep"(%plaid_arg2_2, %35) <{operandSegmentSizes = array<i32: 1, 1>}> : (!neura.data<!llvm.ptr, i1>, !neura.data<i64, i1>) -> !neura.data<!llvm.ptr, i1>
    ...
    %plaid_fused_2:2 = "neura.fused_op"(%27, %21, %19) <{frequency = 1 : i64, pattern_id = 2 : i64, pattern_name = "plaid.unicast:add->gep->load"}> ({
    ^bb0(%plaid_arg3_0: !neura.data<i64, i1>, %plaid_arg3_1: !neura.data<i64, i1>, %plaid_arg3_2: !neura.data<!llvm.ptr, i1>):
      %38 = "neura.add"(%plaid_arg3_0, %plaid_arg3_1) : (!neura.data<i64, i1>, !neura.data<i64, i1>) -> !neura.data<i64, i1>
      %39 = "neura.gep"(%plaid_arg3_2, %38) <{operandSegmentSizes = array<i32: 1, 1>}> : (!neura.data<!llvm.ptr, i1>, !neura.data<i64, i1>) -> !neura.data<!llvm.ptr, i1>
    ...
    "neura.store"(%31, %plaid_fused_2#0) : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
    %plaid_fused_3 = "neura.fused_op"(%29, %plaid_fused_1, %plaid_fused_2#1, %plaid_fused_0#1) <{frequency = 1 : i64, pattern_id = 3 : i64, pattern_name = "plaid.fan_in:mul->mul->sub"}> ({
    ^bb0(%plaid_arg4_0: !neura.data<i32, i1>, %plaid_arg4_1: !neura.data<i32, i1>, %plaid_arg4_2: !neura.data<i32, i1>, %plaid_arg4_3: !neura.data<i32, i1>):
      %41 = "neura.mul"(%plaid_arg4_0, %plaid_arg4_1) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
      %42 = "neura.mul"(%plaid_arg4_2, %plaid_arg4_3) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
    ...
    "neura.store"(%plaid_fused_3, %19) : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
    %plaid_fused_4 = "neura.fused_op"(%plaid_fused_2#1, %plaid_fused_1, %29, %plaid_fused_0#1) <{frequency = 1 : i64, pattern_id = 4 : i64, pattern_name = "plaid.fan_in:mul->mul->add"}> ({
    ^bb0(%plaid_arg5_0: !neura.data<i32, i1>, %plaid_arg5_1: !neura.data<i32, i1>, %plaid_arg5_2: !neura.data<i32, i1>, %plaid_arg5_3: !neura.data<i32, i1>):
      %44 = "neura.mul"(%plaid_arg5_0, %plaid_arg5_1) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
      %45 = "neura.mul"(%plaid_arg5_2, %plaid_arg5_3) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
      %46 = "neura.add"(%44, %45) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
      neura.yield results(%46 : !neura.data<i32, i1>)
    }) : (!neura.data<i32, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
    "neura.store"(%plaid_fused_4, %17) : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
    %plaid_fused_5:3 = "neura.fused_op"(%27, %25, %15) <{frequency = 1 : i64, pattern_id = 5 : i64, pattern_name = "plaid.unicast:add->icmp->not"}> ({
    ^bb0(%plaid_arg6_0: !neura.data<i64, i1>, %plaid_arg6_1: !neura.data<i64, i1>, %plaid_arg6_2: !neura.data<i64, i1>):
      %47 = "neura.add"(%plaid_arg6_0, %plaid_arg6_1) : (!neura.data<i64, i1>, !neura.data<i64, i1>) -> !neura.data<i64, i1>
      %48 = "neura.icmp"(%47, %plaid_arg6_2) <{cmpType = "eq"}> : (!neura.data<i64, i1>, !neura.data<i64, i1>) -> !neura.data<i1, i1>
      %49 = "neura.not"(%48) : (!neura.data<i1, i1>) -> !neura.data<i1, i1>
      neura.yield results(%47, %48, %49 : !neura.data<i64, i1>, !neura.data<i1, i1>, !neura.data<i1, i1>)
    }) : (!neura.data<i64, i1>, !neura.data<i64, i1>, !neura.data<i64, i1>) -> (!neura.data<i64, i1>, !neura.data<i1, i1>, !neura.data<i1, i1>)
    %50 = neura.grant_predicate %plaid_fused_4, %plaid_fused_5#2 : !neura.data<i32, i1>, !neura.data<i1, i1> -> !neura.data<i32, i1>
    neura.ctrl_mov %50 -> %30 : !neura.data<i32, i1> !neura.data<i32, i1>
    %51 = neura.grant_predicate %plaid_fused_3, %plaid_fused_5#2 : !neura.data<i32, i1>, !neura.data<i1, i1> -> !neura.data<i32, i1>
    neura.ctrl_mov %51 -> %28 : !neura.data<i32, i1> !neura.data<i32, i1>
    %52 = neura.grant_predicate %plaid_fused_5#0, %plaid_fused_5#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %52 -> %26 : !neura.data<i64, i1> !neura.data<i64, i1>
    %53 = neura.grant_predicate %25, %plaid_fused_5#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %53 -> %24 : !neura.data<i64, i1> !neura.data<i64, i1>
    %54 = neura.grant_predicate %23, %plaid_fused_5#2 : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %54 -> %22 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    %55 = neura.grant_predicate %21, %plaid_fused_5#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %55 -> %20 : !neura.data<i64, i1> !neura.data<i64, i1>
    %56 = neura.grant_predicate %19, %plaid_fused_5#2 : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %56 -> %18 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    %57 = neura.grant_predicate %17, %plaid_fused_5#2 : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
    neura.ctrl_mov %57 -> %16 : !neura.data<!llvm.ptr, i1> !neura.data<!llvm.ptr, i1>
    %58 = neura.grant_predicate %15, %plaid_fused_5#2 : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
    neura.ctrl_mov %58 -> %14 : !neura.data<i64, i1> !neura.data<i64, i1>
    %59 = neura.grant_predicate %plaid_fused_5#1, %plaid_fused_5#1 : !neura.data<i1, i1>, !neura.data<i1, i1> -> !neura.data<i1, i1>
