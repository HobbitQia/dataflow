  ...
  func.func @llama_attention_ffn(%arg0: memref<16xi32>, %arg1: memref<16x16xi32>, %arg2: memref<16xi32>, %arg3: memref<16xi32>, %arg4: memref<1xi32>, %arg5: memref<16x16xi32>, %arg6: memref<16xi32>, %arg7: memref<16x16xi32>, %arg8: memref<16xi32>, %arg9: memref<16x16xi32>, %arg10: memref<16xi32>, %arg11: memref<16xi32>, %arg12: memref<16x16xi32>, %arg13: memref<16xi32>) attributes {latency = 1 : i32} {
    ...
    ^bb0(%arg14: memref<16xi32>, %arg15: memref<16xi32>, %arg16: memref<16x16xi32>, %arg17: memref<16xi32>):
      ...
      ^bb0(%arg18: memref<16xi32>, %arg19: memref<16xi32>, %arg20: memref<16x16xi32>):
        %3:4 = "neura.fused_op"() <{frequency = 3 : i64, pattern_id = 1 : i64, pattern_name = "fused_op:counter->load_indexed->fused_op:fused_op:counter->add->fused_op:load_indexed->fused_op:load_indexed->mul"}> ({
        ...
        %11 = "neura.fused_op"(%7, %9, %8) <{frequency = 3 : i64, pattern_id = 4 : i64, pattern_name = "fused_op:load_indexed->fused_op:load_indexed->mul->add"}> ({
    ...
    ^bb0(%arg14: memref<16xi32>, %arg15: memref<16xi32>, %arg16: i32):
      ...
      ^bb0(%arg17: memref<16xi32>, %arg18: i32, %arg19: memref<16xi32>):
        ...
        %7 = "neura.fused_op"(%5) <{frequency = 5 : i64, pattern_id = 7 : i64, pattern_name = "fused_op:load_indexed->mul->add"}> ({
    ...
    ^bb0(%arg14: memref<16xi32>, %arg15: memref<16xi32>, %arg16: memref<16x16xi32>, %arg17: memref<16xi32>, %arg18: memref<16x16xi32>, %arg19: memref<16xi32>, %arg20: memref<16x16xi32>, %arg21: memref<16xi32>, %arg22: memref<16xi32>, %arg23: memref<16xi32>):
      ...
      ^bb0(%arg24: memref<16xi32>, %arg25: memref<16xi32>, %arg26: memref<16x16xi32>, %arg27: memref<16xi32>, %arg28: memref<16x16xi32>, %arg29: memref<16xi32>, %arg30: memref<16x16xi32>):
        %3:4 = "neura.fused_op"() <{frequency = 3 : i64, pattern_id = 1 : i64, pattern_name = "fused_op:counter->load_indexed->fused_op:fused_op:counter->add->fused_op:load_indexed->fused_op:load_indexed->mul"}> ({
          %29 = neura.counter {counter_id = 0 : i32, counter_type = "root", lower_bound = 0 : index, step = 1 : index, upper_bound = 16 : index} : !neura.data<index, i1>
          ...
          %33 = neura.load_indexed [%32, %29 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input2"} : !neura.data<i32, i1>
          ...
          neura.yield results(%29, %30, %31, %35 : !neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<index, i1>, !neura.data<i32, i1>)
        }) {latency = 2 : i32} : () -> (!neura.data<index, i1>, !neura.data<i32, i1>, !neura.data<index, i1>, !neura.data<i32, i1>)
        %4 = "neura.data_mov"(%3#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %5 = "neura.data_mov"(%3#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %6 = "neura.data_mov"(%3#0) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        ...
        %13 = "neura.data_mov"(%3#2) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %14 = "neura.data_mov"(%3#2) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %15 = "neura.data_mov"(%3#2) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %16 = "neura.data_mov"(%3#2) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %17 = "neura.data_mov"(%3#3) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %18:2 = "neura.fused_op"(%12, %17, %11, %16) <{frequency = 6 : i64, pattern_id = 0 : i64, pattern_name = "add->fused_op:fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg31: !neura.data<i32, i1>, %arg32: !neura.data<i32, i1>, %arg33: !neura.data<index, i1>, %arg34: !neura.data<index, i1>):
          %29 = "neura.add"(%arg31, %arg32) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %30 = neura.load_indexed [%arg33, %arg34 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %31 = "neura.mul"(%29, %30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %32 = neura.load_indexed [%arg33 : !neura.data<index, i1>]  {lhs_value = "%input3"} : !neura.data<i32, i1>
          %33 = "neura.add"(%32, %31) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%29, %33 : !neura.data<i32, i1>, !neura.data<i32, i1>)
        ...
        %23 = "neura.fused_op"(%15, %10, %21) <{frequency = 6 : i64, pattern_id = 0 : i64, pattern_name = "add->fused_op:fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg31: !neura.data<index, i1>, %arg32: !neura.data<index, i1>, %arg33: !neura.data<i32, i1>):
          %29 = "neura.add"(%arg31) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %30 = neura.load_indexed [%arg32, %29 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input6"} : !neura.data<i32, i1>
          %31 = "neura.mul"(%arg33, %30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %32 = neura.load_indexed [%arg32 : !neura.data<index, i1>]  {lhs_value = "%input5"} : !neura.data<i32, i1>
          %33 = "neura.add"(%32, %31) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%33 : !neura.data<i32, i1>)
        }) {latency = 2 : i32} : (!neura.data<index, i1>, !neura.data<index, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %24 = "neura.data_mov"(%23) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %25 = "neura.fused_op"(%14, %9, %20) <{frequency = 6 : i64, pattern_id = 0 : i64, pattern_name = "add->fused_op:fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg31: !neura.data<index, i1>, %arg32: !neura.data<index, i1>, %arg33: !neura.data<i32, i1>):
          %29 = "neura.add"(%arg31) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
          %30 = neura.load_indexed [%arg32, %29 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
          %31 = "neura.mul"(%arg33, %30) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %32 = neura.load_indexed [%arg32 : !neura.data<index, i1>]  {lhs_value = "%input3"} : !neura.data<i32, i1>
          %33 = "neura.add"(%32, %31) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          neura.yield results(%33 : !neura.data<i32, i1>)
        }) {latency = 2 : i32} : (!neura.data<index, i1>, !neura.data<index, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %26 = "neura.data_mov"(%25) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %27 = "neura.fused_op"(%8, %13, %19) <{frequency = 6 : i64, pattern_id = 8 : i64, pattern_name = "fused_op:load_indexed->mul->fused_op:load_indexed->add"}> ({
        ^bb0(%arg31: !neura.data<index, i1>, %arg32: !neura.data<index, i1>, %arg33: !neura.data<i32, i1>):
          %29 = neura.load_indexed [%arg31, %arg32 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input6"} : !neura.data<i32, i1>
          %30 = "neura.mul"(%arg33, %29) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
          %31 = neura.load_indexed [%arg31 : !neura.data<index, i1>]  {lhs_value = "%input5"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %22 to [%7 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input3"} : !neura.data<i32, i1>
        neura.store_indexed %26 to [%6 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input3"} : !neura.data<i32, i1>
        neura.store_indexed %28 to [%5 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.store_indexed %24 to [%4 : !neura.data<index, i1>]  {latency = 1 : i32, rhs_value = "%input5"} : !neura.data<i32, i1>
        neura.yield {latency = 1 : i32, yield_type = "void"}
      }
    ...
    ^bb0(%arg14: memref<16xi32>, %arg15: memref<16xi32>, %arg16: memref<16xi32>):
      ...
      ^bb0(%arg17: memref<16xi32>, %arg18: memref<16xi32>, %arg19: memref<16xi32>):
        ...
        %5 = "neura.data_mov"(%2#1) : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %6 = "neura.data_mov"(%2#2) : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
        %7 = "neura.fused_op"(%4) <{frequency = 7 : i64, pattern_id = 9 : i64, pattern_name = "load_indexed->fused_op:load_indexed->mul"}> ({
        ^bb0(%arg20: !neura.data<index, i1>):
