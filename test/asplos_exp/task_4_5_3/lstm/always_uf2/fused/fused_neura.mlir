  ...
  func.func @lstm_cell(%arg0: memref<16xi32>, %arg1: memref<16xi32>, %arg2: memref<16x16xi32>, %arg3: memref<16x16xi32>, %arg4: memref<16x16xi32>, %arg5: memref<16x16xi32>, %arg6: memref<16x16xi32>, %arg7: memref<16x16xi32>, %arg8: memref<16x16xi32>, %arg9: memref<16x16xi32>, %arg10: memref<16xi32>, %arg11: memref<16xi32>, %arg12: memref<16xi32>, %arg13: memref<16xi32>, %arg14: memref<16xi32>, %arg15: memref<16xi32>, %arg16: memref<16xi32>) {
    ...
    ^bb0(%arg17: memref<16xi32>, %arg18: memref<16xi32>, %arg19: memref<16x16xi32>, %arg20: memref<16xi32>, %arg21: memref<16x16xi32>, %arg22: memref<16xi32>, %arg23: memref<16x16xi32>, %arg24: memref<16xi32>, %arg25: memref<16x16xi32>, %arg26: memref<16xi32>, %arg27: memref<16xi32>, %arg28: memref<16xi32>, %arg29: memref<16xi32>):
      ...
      ^bb0(%arg30: memref<16xi32>, %arg31: memref<16xi32>, %arg32: memref<16x16xi32>, %arg33: memref<16xi32>, %arg34: memref<16x16xi32>, %arg35: memref<16xi32>, %arg36: memref<16x16xi32>, %arg37: memref<16xi32>, %arg38: memref<16x16xi32>):
        ...
        %15 = neura.load_indexed [%2 : !neura.data<index, i1>]  {lhs_value = "%input3"} : !neura.data<i32, i1>
        %16 = neura.load_indexed [%3 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        %17 = neura.load_indexed [%2, %3 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %19 to [%2 : !neura.data<index, i1>]  {rhs_value = "%input3"} : !neura.data<i32, i1>
        %20 = "neura.add"(%3) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %21 = neura.load_indexed [%2 : !neura.data<index, i1>]  {lhs_value = "%input3"} : !neura.data<i32, i1>
        %22 = neura.load_indexed [%20 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        %23 = neura.load_indexed [%2, %20 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input4"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %25 to [%2 : !neura.data<index, i1>]  {rhs_value = "%input3"} : !neura.data<i32, i1>
        %26 = neura.load_indexed [%2 : !neura.data<index, i1>]  {lhs_value = "%input5"} : !neura.data<i32, i1>
        %27 = neura.load_indexed [%3 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        %28 = neura.load_indexed [%2, %3 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input6"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %30 to [%2 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        %31 = "neura.add"(%3) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %32 = neura.load_indexed [%2 : !neura.data<index, i1>]  {lhs_value = "%input5"} : !neura.data<i32, i1>
        %33 = neura.load_indexed [%31 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        %34 = neura.load_indexed [%2, %31 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input6"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %36 to [%2 : !neura.data<index, i1>]  {rhs_value = "%input5"} : !neura.data<i32, i1>
        %37 = neura.load_indexed [%2 : !neura.data<index, i1>]  {lhs_value = "%input7"} : !neura.data<i32, i1>
        %38 = neura.load_indexed [%3 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        %39 = neura.load_indexed [%2, %3 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input8"} : !neura.data<i32, i1>
        ...
        neura.store_indexed %41 to [%2 : !neura.data<index, i1>]  {rhs_value = "%input7"} : !neura.data<i32, i1>
        %42 = "neura.add"(%3) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
        %43 = neura.load_indexed [%2 : !neura.data<index, i1>]  {lhs_value = "%input7"} : !neura.data<i32, i1>
        %44 = neura.load_indexed [%42 : !neura.data<index, i1>]  {lhs_value = "%input1"} : !neura.data<i32, i1>
        %45 = neura.load_indexed [%2, %42 : !neura.data<index, i1>, !neura.data<index, i1>]  {lhs_value = "%input8"} : !neura.data<i32, i1>
        %46 = "neura.mul"(%44, %45) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        %47 = "neura.add"(%43, %46) : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
        neura.store_indexed %47 to [%2 : !neura.data<index, i1>]  {rhs_value = "%input7"} : !neura.data<i32, i1>
    ...
    ^bb0(%arg17: memref<16xi32>, %arg18: memref<16xi32>, %arg19: memref<16xi32>, %arg20: memref<16xi32>, %arg21: memref<16xi32>, %arg22: memref<16xi32>, %arg23: memref<16xi32>):
      ...
      ^bb0(%arg24: memref<16xi32>, %arg25: memref<16xi32>, %arg26: memref<16xi32>, %arg27: memref<16xi32>, %arg28: memref<16xi32>, %arg29: memref<16xi32>):
        ...
        %2 = "neura.add"(%1) {rhs_value = 1 : index} : (!neura.data<index, i1>) -> !neura.data<index, i1>
