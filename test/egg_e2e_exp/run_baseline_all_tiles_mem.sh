#!/bin/bash
# Run baseline with architecture_all_tiles_mem.yaml (all tiles can read/write memory)
# Uses the same logic as run_baseline.sh but with the new arch config
...
LOG_FILE="$SCRIPT_DIR/baseline_all_tiles_mem_results.log"
TIMEOUT=600
