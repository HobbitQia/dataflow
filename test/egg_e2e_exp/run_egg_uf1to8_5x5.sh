#!/usr/bin/env bash
# egg-process-neura mapping for all 9 kernels, uf = 1 / 2 / 4 / 8
# NO --generate-code (causes SIGSEGV); metrics read from compiled_ii attributes
...
LOG=$E2E/egg_uf1to8_5x5_results.log
...
exec > >(tee "$LOG") 2>&1
echo "=== egg-process-neura all kernels uf=1/2/4/8 ==="
echo "date: $(date)"
echo ""
