; ModuleID = '/mnt/public/qjj/dataflow/test/e2e/bicg/kernel_uf2.c'
source_filename = "/mnt/public/qjj/dataflow/test/e2e/bicg/kernel_uf2.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nofree norecurse nounwind uwtable
define dso_local void @kernel(i32 %0, i32 %1, [1900 x double]* nocapture readonly %2, double* nocapture %3, double* nocapture %4, double* nocapture readonly %5, double* nocapture readonly %6) local_unnamed_addr #0 {
...
27:                                               ; preds = %23, %27
  ...
  %32 = getelementptr inbounds [1900 x double], [1900 x double]* %2, i64 %24, i64 %28
  ...
  %46 = getelementptr inbounds [1900 x double], [1900 x double]* %2, i64 %24, i64 %42
  ...
  br i1 %57, label %27, label %58, !llvm.loop !6
...
31:                                               ; preds = %31, %23
  ...
  %39 = getelementptr inbounds [1900 x double], [1900 x double]* %8, i64 %24, i64 %32
  store double %38, double* %39, align 8, !tbaa !2
  %40 = icmp eq i64 %33, 1900
  br i1 %40, label %41, label %31, !llvm.loop !11

41:                                               ; preds = %31
  %42 = add nuw nsw i64 %24, 1
  %43 = add nuw nsw i32 %25, 1
  %44 = icmp eq i64 %42, 2100
  br i1 %44, label %45, label %23, !llvm.loop !12

45:                                               ; preds = %41
  %46 = bitcast i8* %4 to double*
  %47 = bitcast i8* %5 to double*
  tail call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(15200) %4, i8 0, i64 15200, i1 false) #4
  br label %48

48:                                               ; preds = %83, %45
  %49 = phi i64 [ 0, %45 ], [ %84, %83 ]
...
52:                                               ; preds = %52, %48
  ...
  %57 = getelementptr inbounds [1900 x double], [1900 x double]* %8, i64 %49, i64 %53
  ...
  %67 = or i64 %53, 1
  %68 = getelementptr inbounds double, double* %46, i64 %67
  %69 = load double, double* %68, align 8, !tbaa !2
  %70 = load double, double* %51, align 8, !tbaa !2
  %71 = getelementptr inbounds [1900 x double], [1900 x double]* %8, i64 %49, i64 %67
  %72 = load double, double* %71, align 8, !tbaa !2
  %73 = fmul double %70, %72
  %74 = fadd double %69, %73
  store double %74, double* %68, align 8, !tbaa !2
  %75 = load double, double* %50, align 8, !tbaa !2
  %76 = load double, double* %71, align 8, !tbaa !2
  %77 = getelementptr inbounds double, double* %9, i64 %67
  %78 = load double, double* %77, align 8, !tbaa !2
  %79 = fmul double %76, %78
  %80 = fadd double %75, %79
  store double %80, double* %50, align 8, !tbaa !2
  %81 = add nuw nsw i64 %53, 2
  %82 = icmp ult i64 %53, 1898
  br i1 %82, label %52, label %83, !llvm.loop !6

83:                                               ; preds = %52
  %84 = add nuw nsw i64 %49, 1
  %85 = icmp eq i64 %84, 2100
