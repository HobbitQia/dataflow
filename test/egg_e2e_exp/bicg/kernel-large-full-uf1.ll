...
define dso_local i32 @main(i32 %0, i8** nocapture readonly %1) local_unnamed_addr #1 {
  %3 = tail call i8* @polybench_alloc_data(i64 3990000, i32 8) #7
  %4 = tail call i8* @polybench_alloc_data(i64 1900, i32 8) #7
  %5 = tail call i8* @polybench_alloc_data(i64 2100, i32 8) #7
  %6 = tail call i8* @polybench_alloc_data(i64 1900, i32 8) #7
  %7 = tail call i8* @polybench_alloc_data(i64 2100, i32 8) #7
...
45:                                               ; preds = %41
  ...
  tail call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(15200) %4, i8 0, i64 15200, i1 false) #7
  br label %48
