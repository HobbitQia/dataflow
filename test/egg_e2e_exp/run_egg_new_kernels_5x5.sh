#!/usr/bin/env bash
# egg-process-neura mapping for new kernels: dtw, mvt, conv, latnrm, gemm_v2
# uf = 1 / 2 / 4
set -uo pipefail
...
LOG=$E2E/egg_new_kernels_5x5_results.log
