; ModuleID = '/mnt/public/qjj/dataflow/test/e2e/gemv/kernel-full-uf2.ll'
source_filename = "/mnt/public/qjj/dataflow/test/e2e/gemv/kernel_uf2.cpp"
...
8:                                                ; preds = %12
  ...
  store i32 %30, i32* %9, align 4, !tbaa !2
  %10 = add nuw nsw i64 %5, 1
  %11 = icmp eq i64 %10, 4
  br i1 %11, label %7, label %4, !llvm.loop !6

12:                                               ; preds = %12, %4
  %13 = phi i1 [ true, %4 ], [ false, %12 ]
  %14 = phi i64 [ 0, %4 ], [ 2, %12 ]
  %15 = phi i32 [ 0, %4 ], [ %30, %12 ]
  %16 = or i64 %14, %6
  ...
  br i1 %13, label %12, label %8, !llvm.loop !9
}
