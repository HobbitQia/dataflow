; ModuleID = '/mnt/public/qjj/dataflow/test/e2e/histogram/kernel_uf4.cpp'
...
3:                                                ; preds = %3, %2
  %4 = phi i64 [ 0, %2 ], [ %44, %3 ]
  %5 = getelementptr inbounds [20 x i32], [20 x i32]* @input_data, i64 0, i64 %4
  %6 = load i32, i32* %5, align 16, !tbaa !2
  %7 = mul i32 %6, 5
  %8 = add i32 %7, -5
  %9 = sdiv i32 %8, 18
  %10 = sext i32 %9 to i64
  %11 = getelementptr inbounds [5 x i32], [5 x i32]* @histogram, i64 0, i64 %10
  %12 = load i32, i32* %11, align 4, !tbaa !2
  %13 = add nsw i32 %12, 1
  store i32 %13, i32* %11, align 4, !tbaa !2
  %14 = or i64 %4, 1
  %15 = getelementptr inbounds [20 x i32], [20 x i32]* @input_data, i64 0, i64 %14
  %16 = load i32, i32* %15, align 4, !tbaa !2
  %17 = mul i32 %16, 5
  %18 = add i32 %17, -5
  %19 = sdiv i32 %18, 18
  %20 = sext i32 %19 to i64
  %21 = getelementptr inbounds [5 x i32], [5 x i32]* @histogram, i64 0, i64 %20
  %22 = load i32, i32* %21, align 4, !tbaa !2
  %23 = add nsw i32 %22, 1
  store i32 %23, i32* %21, align 4, !tbaa !2
  %24 = or i64 %4, 2
  %25 = getelementptr inbounds [20 x i32], [20 x i32]* @input_data, i64 0, i64 %24
  %26 = load i32, i32* %25, align 8, !tbaa !2
  %27 = mul i32 %26, 5
  %28 = add i32 %27, -5
  %29 = sdiv i32 %28, 18
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds [5 x i32], [5 x i32]* @histogram, i64 0, i64 %30
  %32 = load i32, i32* %31, align 4, !tbaa !2
  %33 = add nsw i32 %32, 1
  store i32 %33, i32* %31, align 4, !tbaa !2
  %34 = or i64 %4, 3
  %35 = getelementptr inbounds [20 x i32], [20 x i32]* @input_data, i64 0, i64 %34
  %36 = load i32, i32* %35, align 4, !tbaa !2
  %37 = mul i32 %36, 5
  %38 = add i32 %37, -5
  %39 = sdiv i32 %38, 18
  %40 = sext i32 %39 to i64
  %41 = getelementptr inbounds [5 x i32], [5 x i32]* @histogram, i64 0, i64 %40
