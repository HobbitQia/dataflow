/* fft standalone: single butterfly stage, BPGROUP=128, manually unrolled x4 */
#define BPGROUP 128
...
void kernel(int *data_real, int *data_imag, int Wr, int Wi, long offset)
{
  ...
  int temp_real2, temp_imag2;
  int temp_real3, temp_imag3;
  for (k = 0; k < BPGROUP; k += 4) {
    ...
    temp_real2 = Wr * data_real[offset + BPGROUP + k + 2] -
                 Wi * data_imag[offset + BPGROUP + k + 2];
    temp_imag2 = Wi * data_real[offset + BPGROUP + k + 2] +
                 Wr * data_imag[offset + BPGROUP + k + 2];
    data_real[offset + BPGROUP + k + 2] = data_real[offset + k + 2] - temp_real2;
    data_real[offset + k + 2]          += temp_real2;
    data_imag[offset + BPGROUP + k + 2] = data_imag[offset + k + 2] - temp_imag2;
    data_imag[offset + k + 2]          += temp_imag2;

    temp_real3 = Wr * data_real[offset + BPGROUP + k + 3] -
                 Wi * data_imag[offset + BPGROUP + k + 3];
    temp_imag3 = Wi * data_real[offset + BPGROUP + k + 3] +
                 Wr * data_imag[offset + BPGROUP + k + 3];
    data_real[offset + BPGROUP + k + 3] = data_real[offset + k + 3] - temp_real3;
    data_real[offset + k + 3]          += temp_real3;
    data_imag[offset + BPGROUP + k + 3] = data_imag[offset + k + 3] - temp_imag3;
    data_imag[offset + k + 3]          += temp_imag3;
  }
}
