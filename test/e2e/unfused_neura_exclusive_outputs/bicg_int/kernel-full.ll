; ModuleID = '/mnt/public/qjj/dataflow/test/benchmark/CGRA-Bench/kernels/bicg/bicg_int.c'
source_filename = "/mnt/public/qjj/dataflow/test/benchmark/CGRA-Bench/kernels/bicg/bicg_int.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@main.s = internal unnamed_addr global [8 x i32] zeroinitializer, align 16
...
for.body4:                                        ; preds = %entry, %for.cond.cleanup10
...
entry:
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) @main.s, i8 0, i64 32, i1 false), !tbaa !5
  br label %for.body4.i

for.body4.i:                                      ; preds = %for.cond.cleanup10.i, %entry
  %indvars.iv52.i = phi i64 [ 0, %entry ], [ %indvars.iv.next53.i, %for.cond.cleanup10.i ]
  br label %for.body11.i

for.cond.cleanup10.i:                             ; preds = %for.body11.i
  %indvars.iv.next53.i = add nuw nsw i64 %indvars.iv52.i, 1
  %exitcond56.not.i = icmp eq i64 %indvars.iv.next53.i, 8
  br i1 %exitcond56.not.i, label %kernel_bicg_int.exit, label %for.body4.i, !llvm.loop !9

for.body11.i:                                     ; preds = %for.body11.i, %for.body4.i
  %indvars.iv.i = phi i64 [ 0, %for.body4.i ], [ %indvars.iv.next.i, %for.body11.i ]
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 8
  br i1 %exitcond.not.i, label %for.cond.cleanup10.i, label %for.body11.i, !llvm.loop !12

kernel_bicg_int.exit:                             ; preds = %for.cond.cleanup10.i
  ret i32 0
}
