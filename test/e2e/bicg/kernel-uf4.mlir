...
module attributes {dlti.dl_spec = #dlti.dl_spec<f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64>, llvm.ident = "Ubuntu clang version 12.0.1-19ubuntu3"} {
  ...
  ^bb6(%22: i64):  // 2 preds: ^bb5, ^bb6
    ...
    %26 = llvm.getelementptr inbounds %arg2[%19, %22] : (!llvm.ptr, i64, i64) -> !llvm.ptr, !llvm.array<116 x f64>
    ...
    %40 = llvm.getelementptr inbounds %arg2[%19, %36] : (!llvm.ptr, i64, i64) -> !llvm.ptr, !llvm.array<116 x f64>
    ...
    %54 = llvm.getelementptr inbounds %arg2[%19, %50] : (!llvm.ptr, i64, i64) -> !llvm.ptr, !llvm.array<116 x f64>
    ...
    %68 = llvm.getelementptr inbounds %arg2[%19, %64] : (!llvm.ptr, i64, i64) -> !llvm.ptr, !llvm.array<116 x f64>
