// Compiles single-phase flattened row-major int Jacobi2D stencil to LLVM IR,
// imports it to MLIR, then lowers it via Neura and checks emitted metadata.
// RUN: clang++ -S -emit-llvm -O3 -fno-vectorize -fno-unroll-loops -std=c++17 \
// RUN:   -o %t-kernel-full.ll %S/../../benchmark/jacobi2d_step/jacobi2d_step_int.cpp
...
// MAPPING: func.func @kernel_jacobi2d_step_int
...
// MEMORY: function:
// MEMORY:   name: "kernel_jacobi2d_step_int"
// MEMORY: arguments:
// MEMORY:   - name: "%arg0"
// MEMORY-NEXT:     index: 0
...
// MEMORY-DAG: byte_value: -4
// MEMORY-DAG: word_value: -1
// MEMORY-DAG: byte_value: -32
// MEMORY-DAG: word_value: -8
// MEMORY-DAG: byte_value: 32
// MEMORY-DAG: word_value: 8
