; ModuleID = '/mnt/public/qjj/dataflow/test/e2e/fft/kernel_uf4.c'
...
28:                                               ; preds = %23, %28
  ...
  br i1 %124, label %28, label %125, !llvm.loop !9

125:                                              ; preds = %28, %16
  %126 = add nuw nsw i64 %17, 1
  %127 = icmp eq i64 %126, %15
  br i1 %127, label %128, label %16, !llvm.loop !10
...
128:                                              ; preds = %125, %5
  ...
  br i1 %134, label %135, label %5, !llvm.loop !11
