; ModuleID = '/mnt/public/qjj/dataflow/test/e2e/fir/kernel_uf4.cpp'
...
1:                                                ; preds = %1, %0
  ...
  %5 = getelementptr inbounds [32 x i32], [32 x i32]* @coefficients, i64 0, i64 %2
  %6 = bitcast i32* %4 to <4 x i32>*
  %7 = load <4 x i32>, <4 x i32>* %6, align 16, !tbaa !2
  %8 = bitcast i32* %5 to <4 x i32>*
  %9 = load <4 x i32>, <4 x i32>* %8, align 16, !tbaa !2
  %10 = mul nsw <4 x i32> %9, %7
  %11 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %10)
  %12 = add nsw i32 %11, %3
  %13 = add nuw nsw i64 %2, 4
  %14 = icmp ult i64 %2, 28
  br i1 %14, label %1, label %15, !llvm.loop !6

15:                                               ; preds = %1
  store i32 %12, i32* getelementptr inbounds ([32 x i32], [32 x i32]* @output, i64 0, i64 0), align 16, !tbaa !2
  ret i32 0
}
